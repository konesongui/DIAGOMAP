...
var dtID = 'invoiceDatatable',
    ...
    remoteAJAXFunctions = {
        loadData: 'admin/invoiceitem_supplier/data',
        view: 'admin/invoiceitem_supplier/view',
        edit: 'admin/invoiceitem_supplier/edit',
        print: 'admin/invoiceitem_supplier/print',
        sendEmail: 'admin/invoiceitem/sendEmail',
        addPayment: 'admin/invoiceitem_supplier/addPaymentForm',
        setPayment: 'admin/invoiceitem_supplier/setPayment',
        cancel: 'admin/invoiceitem_supplier/cancel'
