...
var dtID = 'deliveryDatatable',
    remoteAJAXFunctions = {
        ...
        reject: 'admin/deliveryitem_supplier/reject',
        validate: 'admin/deliveryitem_supplier/validate',
        view: 'admin/deliveryitem_supplier/view',
        edit: 'admin/deliveryitem_supplier/edit',
        print: 'admin/deliveryitem_supplier/print',
        sendEmail: 'admin/deliveryitem_supplier/sendEmail',
        partialDelivery: 'admin/deliveryitem_supplier/partialDelivery',
        completeDelivery: 'admin/deliveryitem_supplier/completeDelivery',
        cancelDelivery: 'admin/deliveryitem_supplier/cancelDelivery'
    };
