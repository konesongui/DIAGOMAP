...
var dtID = 'ordersDatatable',
  ...
  remoteAJAXFunctions = {
      ...
      add: 'admin/orders_purchases/add',
      edit: 'admin/orders_purchases/update',
  };
...
$(document).ready(function() {
    ...
    function populateItem(itemSelect, categoryId, selectedItemId = null) {
        if (categoryId) {
            ...
            $.ajax({
                type: "GET",
                url: base_url + "admin/orders_purchases/getItemByCategory",
    ...
    $(document).on('input', '.item-category', function() {
        ...
        if (value) {
            ...
            $.ajax({
                url: base_url + 'admin/orders_purchases/checkCategory',
                type: 'POST',
                ...
                success: function(response) {
                    if (response.exists) {
                        ...
                        $.ajax({
                            url: base_url + 'admin/orders_purchases/getItemsByCategory',
                            type: 'POST',
                            data: { category_name: value },
                            dataType: 'json',
    ...
    $(document).on('click', "#"+dtButtons.edit, function(e) {
        ...
        $.ajax({
            url: baseurl + 'admin/orders_purchases/update',
            type: 'POST',
            data: $form.serialize(),
            dataType: 'json',
            success: function(response) {
                if (response.status === 'success') {
                    Swal.fire({
                        ...
                        window.location.href = base_url + 'admin/orders_purchases';
                    });
                } else {
     ...
     $(document).on('click', "#"+dtButtons.set, function(e) {
        ...
        Swal.fire({
            title: 'Confirmation',
            text: "Voulez-vous enregistrer ce bon de commande ?",
            icon: 'question',
