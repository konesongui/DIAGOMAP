...
var dtID = 'quoteDatatable',
  ...
  remoteAJAXFunctions = {
      loadData: 'admin/quoteitem_purchase/data',
      add: 'admin/quoteitem_purchase/add',
      edit: 'admin/quoteitem_purchase/update',
  };
...
$(document).ready(function() {
    ...
    function populateItem(itemSelect, categoryId, selectedItemId = null) {
        if (categoryId) {
            ...
            $.ajax({
                type: "GET",
                url: base_url + "admin/quoteitem_purchase/getItemByCategory",
    ...
    $(document).on('input', '.item-category', function() {
        ...
        if (value) {
            ...
            $.ajax({
                url: base_url + 'admin/quoteitem_purchase/checkCategory',
                type: 'POST',
                ...
                success: function(response) {
                    if (response.exists) {
                        ...
                        $.ajax({
                            url: base_url + 'admin/quoteitem_purchase/getItemsByCategory',
                            type: 'POST',
                            data: { category_name: value },
                            dataType: 'json',
    ...
    $(document).on('click', "#"+dtButtons.edit, function(e) {
        ...
        $.ajax({
            url: baseurl + 'admin/quoteitem_purchase/update',
            type: 'POST',
            data: $form.serialize(),
            dataType: 'json',
            success: function(response) {
                if (response.status === 'success') {
                    Swal.fire({
                        ...
                        window.location.href = base_url + 'admin/quoteitem_purchase';
                    });
                } else {
