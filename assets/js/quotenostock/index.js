...
var dtID = 'quoteDatatable',
    remoteAJAXFunctions = {
        ...
        reject: 'admin/quotenostock/reject',
        validate: 'admin/quotenostock/validate',
        view: 'admin/quotenostock/view',
        edit: 'admin/quotenostock/edit',
        print: 'admin/quotenostock/print',
        sendEmail: 'admin/quotenostock/sendEmail',
    };
