...
var dtID = 'quotesDatatable',
  ...
  remoteAJAXFunctions = {
      ...
      add: 'admin/selling/add',
      edit: 'admin/selling/update',
  };
...
$(document).ready(function() {
    ...
    function populateItem(itemSelect, categoryId, selectedItemId = null) {
        if (categoryId) {
            ...
            $.ajax({
                type: "GET",
                url: base_url + "admin/selling/getItemByCategory",
    ...
    $(document).on('input', '.item-category', function() {
        ...
        if (value) {
            ...
            $.ajax({
                url: base_url + 'admin/selling/checkCategory',
                type: 'POST',
                ...
                success: function(response) {
                    if (response.exists) {
                        ...
                        $.ajax({
                            url: base_url + 'admin/selling/getItemsByCategory',
                            type: 'POST',
                            data: { category_name: value },
                            dataType: 'json',
    ...
    $(document).on('click', "#"+dtButtons.edit, function(e) {
        ...
        $.ajax({
            url: baseurl + 'admin/selling/update',
            type: 'POST',
            data: $form.serialize(),
            dataType: 'json',
            success: function(response) {
                if (response.status === 'success') {
                    Swal.fire({
                        ...
                        window.location.href = base_url + 'admin/selling';
                    });
                } else {
