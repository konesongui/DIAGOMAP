...
var dtID = 'ordersDatatable',
  ...
  remoteAJAXFunctions = {
      loadData: 'admin/orders_purchase/data',
      add: 'admin/orders_purchase/add',
      edit: 'admin/orders_purchase/update',
  };
...
$(document).ready(function() {
    ...
    function populateItem(itemSelect, categoryId, selectedItemId = null) {
        if (categoryId) {
            ...
            $.ajax({
                type: "GET",
                url: base_url + "admin/orders_purchase/getItemByCategory",
    ...
    $(document).on('input', '.item-category', function() {
        ...
        if (value) {
            ...
            $.ajax({
                url: base_url + 'admin/orders_purchase/checkCategory',
                type: 'POST',
                ...
                success: function(response) {
                    if (response.exists) {
                        ...
                        $.ajax({
                            url: base_url + 'admin/orders_purchase/getItemsByCategory',
                            type: 'POST',
                            data: { category_name: value },
                            dataType: 'json',
    ...
    $(document).on('click', "#"+dtButtons.edit, function(e) {
        ...
        $.ajax({
            url: baseurl + 'admin/orders_purchase/update',
            type: 'POST',
            data: $form.serialize(),
            dataType: 'json',
            success: function(response) {
                if (response.status === 'success') {
                    Swal.fire({
                        ...
                        window.location.href = base_url + 'admin/orders_purchase';
                    });
                } else {
