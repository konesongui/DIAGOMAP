...
class Delivery_model extends CI_Model {
    ...
    protected $items_table = 'delivery_items';
    ...
    public function getListData()
    {
        ...
        $this->db->select('
            ...
            orders.payment_terms as order_payment_terms,
            orders.delivery_terms as order_delivery_terms,
            orders.delivery_location as order_delivery_location,
        ...
        if($search) {
            ...
            $this->db->or_like('deliveries.delivery_number', $search);
        ...
        foreach($query->result() as $row) {
            ...
            $data[] = [
                ...
                'payment_terms' => $row->order_payment_terms ?? 'Non défini',
