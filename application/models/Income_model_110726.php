...
class Income_model extends My_Model
{
    ...
    public function remove($id)
    {
        ...
        // Vérifier d'abord si la caisse existe
        ...
        // Optionnel : Vérifier les opérations liées et les marquer aussi
...
// Dans expense_model.php
    ...
    // Récupérer les sous-comptes d'une caisse
...
// Récupérer un sous-compte spécifique
...
// Mettre à jour le solde d'un sous-compte
