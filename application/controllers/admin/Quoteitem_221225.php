...
// ðÂÂ¸ Même formule que ton JS
    private function calculateTotalsWithBossFormula($quantities, $prices, $discounts, $discount_types)
    {
        ...
        foreach ($quantities as $i => $qty) {
            ...
            // ðÂÂ¹ Calcul du montant de remise unitaire
            $discount_amount_unit = ($discount_type === 'percent')
                ? $price * ($discount / 100)
                : min($discount, $price);

            // ðÂÂ¹ Prix unitaire après remise
...
// ðÂÂ¸ Détail des lignes identique à JS
