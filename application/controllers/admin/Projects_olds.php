...
class Projects extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->session->set_userdata('sub_menu', 'admin/projects');
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $data["status"] = $status;           
            $projects_list = $this->enquiry_model->searchProjects($source, $date_from, $date_to, $status);
        } else {
            $projects_list = $this->enquiry_model->getprojects_list();
        }
        ...
        $this->load->view('admin/frontoffice/projectsview', $data);
