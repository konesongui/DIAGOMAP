...
class Candidatures extends Admin_Controller {
    ...
    function postuler($id)
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST') {
            ...
            if (!empty($_FILES['file']['name'])) {
                ...
                $img_name = 'id' . $applicationData['job_id'] . '.' . $fileInfo['extension'];
                move_uploaded_file(
                    $_FILES["file"]["tmp_name"],
                    "./uploads/front_office/dispatch_receive/" . $img_name
                );
                $this->Recrutements_model->image_add($applicationData['job_id'], $img_name);
            }
