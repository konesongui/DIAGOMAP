...
class Orderformitem_purchase extends Admin_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('order_purchase_model');
    ...
    function index() {
        ...
        $this->session->set_userdata('sub_menu', 'Orderformitem_purchase/index');
        ...
        $this->load->view('admin/itemorder_purchase/list', $data);
    ...
    public function add() {
        ...
        try {
            ...
            $insert_id = $this->order_purchase_model->add($data);
    ...
    public function form() {
        ...
        // Chargement des vues
        $this->load->view('layout/header', $data);
        $this->load->view('admin/itemorder_purchase/form', $data);
        $this->load->view('layout/footer', $data);
    }
    ...
    {   
        ...
        $result = $this->order_purchase_model->getListData();
    ...
    public function update() {
        ...
        try {
            ...
            $order = $this->order_purchase_model->getOrderWithItems($id);
            if (!$order) {
            ...
            $update_success = $this->order_purchase_model->update($data);
        ...
        // Chargement des vues
        $this->load->view('layout/header', $data);
        $this->load->view('admin/itemorder_purchase/edit', $data);
        $this->load->view('layout/footer', $data);
        // Retourner la réponse en JSON
       // echo json_encode($response);
    }
    ...
    private function createDeliveryFromOrder($order_id) {
        ...
        $order = $this->order_purchase_model->getOrderWithItems($order_id);
        if (!$order) {
            return false;
        }
    ...
    public function validate($id) {
        ...
        try {
            ...
            $update_success = $this->order_purchase_model->updateStatus($id, 2); // 2 = Validé
    ...
    public function reject() {
        ...
        try {
            ...
            $update_success = $this->order_purchase_model->rejectOrder($id, $update_data);
    ...
    public function view($id)
    {
        ...
        $data['order'] = $this->order_purchase_model->getOrderWithItems($id);
        ...
        $this->load->view('admin/itemorder_purchase/view', $data);
    ...
    public function prints($id)
    {
        ...
        $order = $this->order_purchase_model->getOrderForPrint($id);
        ...
        $this->load->view('admin/itemorder_purchase/print', ['order' => $order]);
    }
    ...
    public function print()
    {
        ...
        $data['order'] = $this->order_purchase_model->getOrderForPrint($id);
        ...
        $data['totalAsletter'] = $this->asLetters(floatval($data['order']['total_ttc']));
        ...
        $invoice_page = $this->load->view('admin/itemorder_purchase/print', $data, true);
