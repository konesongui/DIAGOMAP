...
class Quotenostock_purchase extends Admin_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('quotenostock_model');
    ...
    public function data()
    {
        ...
        $result = $this->quotenostock_model->getListData();
    ...
    public function form()
    {
        ...
        // Chargement des vues
        $this->load->view('layout/header', $data);
        $this->load->view('admin/quotenostock/form', $data);
        $this->load->view('layout/footer', $data);
    }
