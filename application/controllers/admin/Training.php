...
class Training extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->session->set_userdata('sub_menu', 'training/index');
    ...
    public function getall()
    {
        ...
        $this->session->set_userdata('top_menu', 'HR');
        $this->session->set_userdata('sub_menu', 'training/getall');
        $this->load->view('layout/header');
        $this->load->view('admin/training/getall');
        $this->load->view('layout/footer');
    }
    ...
    public function import()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect('admin/training/import');
        }
    }
    ...
    public function issue_report()
    {
        ...
        $this->session->set_userdata('top_menu', 'Formations');
