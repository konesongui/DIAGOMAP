                    ...
                    <div class="">
                        ...
                        <div class="box-body table-responsive">
                            <div class="download_label">
                                ...
                                <?php echo $this->lang->line('expense') . " " . $this->lang->line('report');
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <?php foreach ($transferts as $transfert): ?>
                                    <tr>
                                        <td><?= get_caisse_name($transfert->from_id); ?></td>
                                        <td><?= get_caisse_name($transfert->to_id); ?></td>
...
<script>
    $(document).ready(function() {
        initDatatable('expense-list','report/gettransferlistbydt');
            ...
            $.ajax({
                ...
                success: function(response) { // your success handler
                    ...
                    if(!response.status){
                        ...
                        initDatatable('expense-list','report/gettransferlistbydt',response.params);
                    }
                },
