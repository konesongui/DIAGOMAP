        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('report/charge_its') ?>" method="post" class="">
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i>CHARGE ITS</h3>
                        </div>
                        <div class="box-body table-responsive">
                            ...
                            <tr>
                                ...
                                <th class="text-primary"><?php echo $this->lang->line('name'); ?></th>
