                ...
                <div class="box removeboxmius">
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i><b style="color: black">JOURNAL COMPTABLE SIMPLIFIE</b></h3>
                        </div>
                        <div class="box-body table-responsive">
                            <div class="download_label">
                                ...
                                <br/><br/><br/><br/>
                                <?php
                                echo "JOURNAL COMPTABLE SIMPLIFIE <br/><br/>";
                            ...
                            <tr>
                                ...
                                <th class="text text-left text-primary">Crédit(Revenu)</th>
                                <th class="text text-left text-primary">Debit(Dépense)</th>
                            ...
                            if (empty($journal)) {
                                ...
                                foreach ($journal as $key => $value) {
                                    ...
                                    $montant_re += $value["montant_revenu"];
                                    $montant_de += $value["montant_depense"];
                                    ?>
                                    <tr>
                               ...
                               <tr class="box box-solid total-bg">
                                   ...
                                   <td><?php echo (number_format($montant_re, 2, '.', '')); ?> </td>


                                   <td><?php echo (number_format($montant_de, 2, '.', '')); ?></td>
                            ...
                            <tr class="box box-solid total-bg">
                                ...
                                <td></td>
                                <td class="text text-left text-primary">Bénéfice </td>

                                <td><?php echo (number_format($montant_re - $montant_de, 2, '.', '')); ?> FCFA </td>
