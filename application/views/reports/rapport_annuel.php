...
$sql = "
  SELECT 
    ...
    SUM(CASE WHEN type_mouvement = 'entree' THEN montant ELSE 0 END) AS total_entree,
    SUM(CASE WHEN type_mouvement = 'depense' THEN montant ELSE 0 END) AS total_depense,
    SUM(CASE WHEN type_mouvement = 'entree' THEN montant ELSE 0 END)
      - SUM(CASE WHEN type_mouvement = 'depense' THEN montant ELSE 0 END) AS solde_annuel
FROM mouvements
GROUP BY YEAR(date_mouvement)
ORDER BY YEAR(date_mouvement);
