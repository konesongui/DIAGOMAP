        ...
        <div class="box box-primary border0 mb0 margesection">
            ...
            <div class="">
                <ul class="reportlists">
                    ...
                    <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/commercial/commercial'); ?>"><a href="<?php echo base_url(); ?>report/commercial"><i class="fa fa-file-text-o"></i> Livre de caisse</a></li>
                    ...
                    if ($this->rbac->hasPrivilege('payroll_report', 'can_view')) {
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/journal_comptable_simplifie'); ?>"><a href="<?php echo base_url(); ?>report/journal_comptable_simplifie"><i class="fa fa-file-text-o"></i>Journal Comptable simplifié</a></li>
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/compte_resultat'); ?>"><a href="<?php echo base_url(); ?>report/compte_resultat"><i class="fa fa-file-text-o"></i>Compte de resultat</a></li>-->
                    ...
                    if ($this->rbac->hasPrivilege('income_report', 'can_view')) {
                        ?>
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/commercial/comemrcial'); ?>"><a href="<?php echo base_url(); ?>report/recapt_facture_client"><i class="fa fa-file-text-o"></i>Recapt Facture Client</a></li>
