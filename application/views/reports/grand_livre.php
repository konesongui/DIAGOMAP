...
$sql = "
    ...
    GROUP BY ae.account, ae.description, i.invoice_number
    ORDER BY ae.account, i.invoice_number, ae.date
";
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('report/grand_livre') ?>" method="post" class="">
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i><b style="color: black">Grand Livre</b></h3>
                        </div>
                        <div class="box-body table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tbody>
                                <?php if(isset($grand_ledger) && !empty($grand_ledger)): ?>
                                    <?php foreach($grand_ledger as $row): ?>
                                        <tr>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" class="text-center">Aucune écriture comptable disponible</td>
                                    </tr>
                                <?php endif; ?>
                                </tbody>
                            </table>
