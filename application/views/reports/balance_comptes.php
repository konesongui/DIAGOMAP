...
$sql = "
    SELECT
        ...
        SUM(ae.debit) - SUM(ae.credit) AS solde
                ...
                <div class="box removeboxmius">
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i><b style="color: black">Balance des comptes</b></h3>
                        </div>
                        <div class="box-body table-responsive">
                            <div class="download_label">
                                ...
                                <br/><br/><br/><br/>
                                <?php
                                echo "Balance des comptes <br/><br/>";
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="4">Aucune écriture comptable disponible</td>
                                    </tr>
                                <?php endif; ?>
                                </tbody>
                            </table>
