                ...
                <div class="box removeboxmius">
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i><b style="color: black">CHARGE CNPS & CMU</b></h3>
                        </div>
                        <div class="box-body table-responsive">
                            ...
                            <tr>
                                ...
                                <th class="text-primary">Cnps régime</th>
                            ...
                            if (empty($payrollList)) {
                                ...
                                <tr class="box box-solid total-bg">
                                    ...
                                    <td><?php echo (number_format($cmu, 2, '.', '')); ?> FCFA</td>

                                    <td><?php echo (number_format($cnps_regim, 2, '.', '')); ?> FCFA</td>
                                    <td><?php echo (number_format($cnps_pres, 2, '.', '')); ?> FCFA</td>

                                    <td><?php echo (number_format($cnps_tra, 2, '.', '')); ?> FCFA</td>
