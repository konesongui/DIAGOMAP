...
<head>
    ...
    <link href="<?php echo base_url(); ?>uploads/school_content/admin_logo/<?php $this->setting_model->getAdminlogo();?>" rel="shortcut icon" type="image/x-icon">
            ...
            <div class="col-lg-5 col-md-3 col-sm-2 col-xs-5">
                        <span href="#"  class="sidebar-session" style="color: white">
                           <?php echo $this->setting_model->getCurrentSchoolName(); ?>&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                            <?php date_default_timezone_get('Africa');
                            echo  date('H:i')?>
                        </span>
            </div>
                ...
                <div class="pull-right">
                    ...
                    <div class="navbar-custom-menu">
                        ...
                        <ul class="nav navbar-nav headertopmenu">
                            ...
                            ?>
                            <li class="cal15"><a data-placement="bottom"  data-toggle="tooltip" style="font-size:20px" title="<?php echo $this->lang->line('home') ?>" target="_blank"  href="https://chat.whatsapp.com/D31Bq8STlU3BNn87VAv6Nf" ><i class="fa fa-home"></i></a>
