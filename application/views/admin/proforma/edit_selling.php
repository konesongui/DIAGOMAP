                            ...
                            <div class="col-md-12">
                                ...
                                <div id="items-container">
                                    <?php foreach ($quote['items'] as $item) {
                                        ...
                                        // Utiliser unit_price_ttc s'il existe, sinon unit_price
...
<script type="text/javascript">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Calcul d'un article (avec conversion TTC -> HT)
        ...
        document.getElementById('add-item').addEventListener('click', function() {
            ...
            clone.querySelector('.remove-item').addEventListener('click', function() { clone.remove(); calculateTotals(); });
            calculateTotals();
        });
        document.querySelectorAll('.remove-item').forEach(btn => {
            btn.addEventListener('click', function() { this.closest('.repeater-item').remove(); calculateTotals(); });
        });

        // Chargement des articles par catégorie (AJAX)
