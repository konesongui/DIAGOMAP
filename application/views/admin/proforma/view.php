...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <small><?php echo $pro['pro_number']; ?></small>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Informations du proforma</h4>
                                <table class="table table-bordered table-striped">
                                    <tr>
                                        <th>Référence</th>
                                        <td><span class="pf-ref"><?php echo $pro['pro_number']; ?></span></td>
                                    </tr>
                                    <tr>
                                        <th>Date d'émission</th>
                                        <td><?php echo date('d/m/Y', strtotime($pro['pro_date'])); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Date de validité</th>
                                        <td><?php echo date('d/m/Y', strtotime($pro['valid_until'])); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Objet</th>
                                        <td><?php echo $pro['objet']; ?></td>
                                    </tr>
                                    <!--<tr>
                                        <th>Statut</th>
                                        <td>
                                    ...
                                    $status = isset($status_labels[$pro['status']]) ? $status_labels[$pro['status']] : ['label' => 'Inconnu', 'class' => 'label-default'];
                                    ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="table table-bordered table-striped">
                                    <tr>
                                        <th>Client</th>
                                        <td><?php echo $pro['customer_name'] . ' ' . $pro['customer_last_name']; ?></td>
                                    </tr>
                                    <?php if (!empty($pro['customer_email'])) : ?>
                                        <tr>
                                            <th>Email</th>
                                            <td><?php echo $pro['customer_email']; ?></td>
                                        </tr>
                                    <?php endif; ?>
                                    <?php if (!empty($pro['customer_phone'])) : ?>
                                        <tr>
                                            <th>Téléphone</th>
                                            <td><?php echo $pro['customer_phone']; ?></td>
                                        </tr>
                                    <?php endif; ?>
                                    <?php if (!empty($pro['customer_address'])) : ?>
                                        <tr>
                                            <th>Adresse</th>
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="table table-bordered table-striped">
                                    <tr>
                                        ...
                                        <td><?php echo $pro['payment_terms']; ?></td>
                                    </tr>
                                    <?php if (!empty($pro['payment_method'])): ?>
                                        <tr>
                                            <th>Mode de paiement</th>
                                            <td><?php echo $pro['payment_method']; ?></td>
                                        </tr>
                                    <?php endif; ?>
                                </table>
                            </div>
                            <div class="col-md-6">
                                ...
                                <table class="table table-bordered table-striped">
                                    <tr>
                                        ...
                                        <td><?php echo $pro['delivery_terms']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Lieu de livraison</th>
                                        <td><?php echo $pro['delivery_location']; ?></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        <table class="table">
                                            <tr>
                                                <th>Total HT</th>
                                                <td class="text-right"><?php echo number_format($pro['total_ht'], 2, ',', ' ') . ' ' . $currency_symbol; ?></td>
                                            </tr>

                                            <!-- Affichage des remises individuelles -->
                                            <?php if (isset($pro['total_discount']) && $pro['total_discount'] > 0): ?>
                                                <tr>
                                                    <th>Total remises articles</th>
                                                    <td class="text-right text-danger">- <?php echo number_format($pro['total_discount'], 2, ',', ' ') . ' ' . $currency_symbol; ?></td>
                                                </tr>
                                            <?php endif; ?>

                                            <!-- Affichage de la remise globale -->
                                            <?php if (isset($pro['global_discount_amount']) && $pro['global_discount_amount'] > 0):
                                                $global_discount_display = '';
                                                if ($pro['global_discount_type'] === 'percent') {
                                                    $global_discount_display = $pro['global_discount_amount'] . '%';
                                                } else {
                                                    $global_discount_display = number_format($pro['global_discount_amount'], 2, ',', ' ') . ' ' . $currency_symbol;
                                                }
                                                ?>
                                                <tr>
                                                    <th>Remise globale <?php echo $global_discount_display; ?></th>
                                                    <td class="text-right text-danger">- <?php echo number_format($pro['global_discount_amount'], 2, ',', ' ') . ' ' . $currency_symbol; ?></td>
                                                </tr>
                                            <?php endif; ?>

                                            <!-- Total après remise -->
                                            <?php if (isset($pro['total_after_discount']) && $pro['total_after_discount'] != $pro['total_ht']): ?>
                                                <tr class="subtotal-row">
                                                    <th>Total après remise</th>
                                                    <td class="text-right text-success">
                                                        <strong><?php echo number_format($pro['total_after_discount'], 2, ',', ' ') . ' ' . $currency_symbol; ?></strong>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                                            ...
                                            <?php
                                            $tax_option = isset($pro['tax_option']) ? $pro['tax_option'] : 'none';
                                            if ($tax_option === 'tva'): ?>
                                                <tr>
                                                    <th>TVA (<?php echo isset($pro['tva_rate']) ? $pro['tva_rate'] : 18; ?>%)</th>
                                                    <td class="text-right"><?php echo number_format($pro['tva_amount'], 2, ',', ' ') . ' ' . $currency_symbol; ?></td>
                                                </tr>
                                            <?php elseif ($tax_option === 'other' && isset($pro['other_tax_amount']) && $pro['other_tax_amount'] > 0): ?>
                                                <tr>
                                                    <th>
                                                        <?php echo !empty($pro['other_tax_name']) ? htmlspecialchars($pro['other_tax_name']) : 'Autre taxe'; ?>
                                                        (<?php echo isset($pro['other_tax_rate']) ? number_format($pro['other_tax_rate'], 2, ',', ' ') : 0; ?>%)
                                                    </th>
                                                    <td class="text-right"><?php echo number_format($pro['other_tax_amount'], 2, ',', ' ') . ' ' . $currency_symbol; ?></td>
                                                </tr>
                                            <?php endif; ?>

                                            <!-- Affichage du montant total de taxe (pour compatibilité) -->
                                            <?php if (isset($pro['total_tax_amount']) && $pro['total_tax_amount'] > 0): ?>
                                                <tr class="tax-total-row">
                                                    <th>Total taxes</th>
                                                    <td class="text-right"><?php echo number_format($pro['total_tax_amount'], 2, ',', ' ') . ' ' . $currency_symbol; ?></td>
                                                </tr>
                                            <?php endif; ?>
                                            ...
                                            <tr class="total-row">
                                                <th>Total
                                                    ...
                                                    if ($tax_option === 'tva') {
                                                        ...
                                                        echo !empty($pro['other_tax_name']) ? htmlspecialchars($pro['other_tax_name']) . ' inclus' : 'TTC';
                                                    } else {
                                                        echo 'HT';
                                                    }
                                                    ?>
                                                ...
                                                <td class="text-right">
                                                    <strong class="total-amount"><?php echo number_format($pro['total_ttc'], 2, ',', ' ') . ' ' . $currency_symbol; ?></strong>
                                                </td>
                                            </tr>
                                            ...
                                            <?php
                                            $total_savings = 0;
                                            if (isset($pro['total_discount'])) {
                                                $total_savings += $pro['total_discount'];
                                            }
                                            if (isset($pro['global_discount_amount'])) {
                                                $total_savings += $pro['global_discount_amount'];
                                            }
                                            if ($total_savings > 0):
                                                ?>
                        ...
                        <?php if (!empty($pro['notes'])) : ?>
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <h4>Notes</h4>
                                    <div class="well">
                                        <?php echo nl2br($pro['notes']); ?>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
