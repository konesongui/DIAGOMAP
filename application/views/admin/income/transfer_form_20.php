...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Formulaire de transfert</h3>
                        </div><!-- /.box-header -->
            ...
            <div class="col-md-<?php echo ($this->rbac->hasPrivilege('transfer', 'can_add')) ? '8' : '12'; ?>">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="transfertTable">
                                <thead>
                                <tr>
                                    <th>Compte source</th>
...
<script>
    $(document).ready(function () {
        // Initialiser DataTable avec les colonnes modifiées
    ...
    $(window).on('load', function() {
        console.log('Page chargée, chargement des comptes');
        loadAccounts('from');
        loadAccounts('to');

        // Mettre à jour les infos quand le montant change
        ...
        // Vérifier les changements sur les sélecteurs
