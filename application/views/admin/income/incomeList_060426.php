                                    ...
                                    <?php if (!empty($caisses)): ?>
                                        <?php foreach ($caisses as $caisse): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo date('d/m/Y', strtotime($caisse['date'])); ?></td>
                                                <td>
                                                ...
                                                <td class="no-print">
                                                    <div class="btn-group btn-group-xs">
                                                        ...
                                                        <?php if ($this->rbac->hasPrivilege('superadmin')): ?>
                                                            ...
                                                            <!-- NOUVEAU BOUTON : Mettre à jour la date de création -->
        ...
        <div style="margin-top: 20px;">
            <table class="print-table">
                <tr class="print-totals">
                    ...
                    <td style="text-align: right; color: black;"><strong>${totalEntrees}</strong></td>
                    <td style="text-align: right; color: black;"><strong>${totalSorties}</strong></td>
                    <td colspan="2"></td>
                </tr>
            </table>
        </div>
