...
// ===============================
// 10. MONTANT NET (CA Réalisé - Dépenses totales)
// ===============================
$montant_net = $ca_realise - $total_depenses_global;

// ===============================
// 10bis. RÉSULTAT NET ENCAISSÉ (CA Encaissé - Déjà payé/décaissé)
// ===============================
...
<head>
    ...
    <style>
        ...
        .icon-resultat-net-encaisse { background: #8e44ad; }  /* Nouvelle couleur */
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <!-- NOUVEAU : Résultat net (CA Encaissé - Déjà payé) -->

        <!-- MONTANT NET (CA Réalisé - Dépenses totales) -->
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="small-box" style="border-left: 5px solid #8e44ad;">
                    <div class="inner">
                        ...
                        <!-- Pas de bouton "Voir plus" par simplicité, mais vous pouvez en ajouter si besoin -->
                    </div>
...
<div class="modal fade" id="modalDejaPaye" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5>Répartition par source</h5>
                <table class="table table-bordered"><table><th>Source</th><th>Montant décaissé (FCFA)</th></tr>
