...
// ===============================
// OPÉRATIONS DE CAISSE (entrées/sorties) - EXCLURE LES TRANSFERTS (TRF)
// ===============================
...
// ===============================
// TRANSFERTS CAISSE/BANQUE (réapprovisionnements)
// ===============================
...
// Totaux transferts (réapprovisionnements)
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <!-- TRANSFERTS TOTAUX (Réapprovisionnements) -->
            <div class="col-md-3 col-sm-6">
                <div class="small-box">
                    <div class="inner">
        ...
        <!-- OPÉRATIONS RÉCENTES -->
        <div class="row">
            <!-- Opérations de caisse (hors transferts) -->
            <div class="col-md-12">
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="5" class="text-center">Aucune opération de caisse (hors transferts)</td>
                                    </tr>
                                <?php endif; ?>
                                </tbody>
                            </table>
            ...
            <!-- Transferts (réapprovisionnements) -->
            <div class="col-md-12">
                <div class="box box-maroon">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-random"></i> Derniers réapprovisionnements (transferts)</h3>
                        <div class="box-tools pull-right">
