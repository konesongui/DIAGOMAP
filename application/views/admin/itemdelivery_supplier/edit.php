        ...
        <div class="row">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Modifier le bon  <?php echo $delivery['delivery_number']; ?></h3>
                </div>
                
                <form action="<?php echo site_url('admin/supplier_order/update') ?>" id="<?= $formID; ?>" method="post" accept-charset="utf-8">
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo base_url('admin/supplier_order'); ?>" class="btn btn-default">
