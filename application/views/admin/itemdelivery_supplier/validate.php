    ...
    <section class="content">
        <div class="row">
            <div class="box box-primary">
                ...
                <form action="<?php echo site_url('admin/deliveryitem_supplier/update') ?>" id="<?= $formID; ?>" method="post" accept-charset="utf-8">
                    <div class="box-body">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/delivery_supplier/actionsPartial.js"></script>