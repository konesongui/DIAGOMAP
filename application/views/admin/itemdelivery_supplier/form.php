            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Bon de commande fournisseur</h3>
                    </div>

                        <form action="<?php echo site_url('admin/deliveryitem_supplier/add') ?>" id="<?= $formID; ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           list="category-list"
                                                           placeholder="Sélectionnez ou enregistrez une catégorie">
                                                    <datalist id="category-list">
                                                        <?php foreach ($itemcatlist as $category): ?>
                                                            <option value="<?= $category['item_category'] ?>"></option>
                                                        <?php endforeach; ?>
                                                    </datalist>
                                                </div>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           list="item-list"
                                                           placeholder="Sélectionnez ou enregistrez un article">
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="number"
                                                           ...
                                                           min="0"
                                                           step="1">
                                                    <div class="availability mt-2 text-primary fw-bold">
                                                ...
                                                <div class="form-group col-md-1">
                                                    <label>Total</label>
                                                    <div class="total-price pt-2">0.00</div>
                                                </div>
                                    ...
                                    <button type="button" id="add-item" class="btn btn-primary btn-sm mt-3">
                            ...
                            <div class="box-footer">
                                ...
                                <a href="<?php echo base_url('admin/deliveryitem_supplier'); ?>" class="btn btn-default">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/delivery_supplier/actions.js"></script>