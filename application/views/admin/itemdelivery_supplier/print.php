...
$payment_terms = $delivery['shipping_method'] ?? "N/A";
$valid_until = $delivery['valid_until'] ?? "N/A";
$delivery_terms = $delivery['tracking_number'] ?? "N/A";
$delivery_location = $delivery['delivery_address'] ?? "N/A";
...
<div class="head">Bon de commande d'achat N° <?= $deliveryNumber ?></div>
...
<div class="info-section">
    ...
    <!-- Client -->
    <div class="info-box client-box" style="margin-top: 70px">
        <!-- QR Code au-dessus des infos client -->
        <div style="margin-bottom: 10px; text-align: left;">
            <img src="<?= $qrCodePath ?>" alt="QR Code" style="width: 100px;">
        </div>

        <strong>Fournisseur :</strong> <?= $customerFullname ?><br>
...
<table class="products-table">
    ...
    <?php foreach ($items as $item): ?>
        <tr>
            ...
            <td><?= htmlspecialchars($item['delivered_quantity']) ?></td>
...
<div style="position: fixed; bottom: 0.3cm; left: 0.3cm; right: 0.3cm;
    ...
    <table style="width: 100%; border-collapse: collapse; background-color: white;  border: 2px solid black;  /* Ajout de la bordure noire */">
        <tr>
            <!-- Colonne 1 -->
