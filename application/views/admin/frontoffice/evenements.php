<!-- ============================================================
     ...
     DESCRIPTION : Interface moderne pour la gestion des événements
     ============================================================ -->
...
<style>
    ...
    .badge-type.culte { background: #dbeafe; color: #1d4ed8; }
    .badge-type.conference { background: #f3e8ff; color: #7c3aed; }
    .badge-type.seminaire { background: #fef3c7; color: #92400e; }
    .badge-type.formation { background: #d1fae5; color: #059669; }
    .badge-type.concert { background: #fce4ec; color: #dc2626; }
    .badge-type.reveil { background: #fef2f2; color: #991b1b; }
    .badge-type.jeunesse { background: #f3e8ff; color: #7c3aed; }
    .badge-type.enfants { background: #d1fae5; color: #059669; }
            ...
            <div class="col-md-12">
                <div class="card-modern">
                    <div class="card-header">
                        <h3>
                            <i class="fa fa-calendar"></i> Gestion des événements
                        ...
                        <div class="d-flex align-items-center gap-3" style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                            ...
                            <button type="button" class="btn-add-modern" onclick="openAddModal()">
                                <i class="fa fa-plus-circle" style="margin-right: 6px;"></i> Nouvel événement
                            </button>
                        </div>
                    </div>
                    ...
                    <div style="padding: 20px 24px 0;">
                        <div class="stats-grid">
                            ...
                            <div class="stat-card" style="border-left-color: #10b981;">
                                <div class="stat-info">
                                    <h4><i class="fa fa-clock-o" style="color:#10b981;"></i> À venir</h4>
                                    <p class="number"><?php echo isset($stats['a_venir']) ? $stats['a_venir'] : 0; ?></p>
                                </div>

                            </div>
                            <div class="stat-card" style="border-left-color: #f59e0b;">
                                <div class="stat-info">
                                    <h4><i class="fa fa-check-circle" style="color:#f59e0b;"></i> Planifiés</h4>
                            ...
                            <div class="stat-card" style="border-left-color: #8b5cf6;">
                                <div class="stat-info">
                                    <h4><i class="fa fa-flag" style="color:#8b5cf6;"></i> En cours</h4>
                                    <p class="number"><?php echo isset($stats['statut_en_cours']) ? $stats['statut_en_cours'] : 0; ?></p>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-modern" id="evenementsTable">
                                <thead>
                                <tr>
                                    <th style="width: 5%;">#</th>
                                ...
                                <?php if (empty($evenements)) : ?>
                                    <tr>
                                        <td colspan="8" class="text-center text-muted" style="padding: 60px 0;">
                                            <i class="fa fa-calendar" style="font-size: 48px; color: #cbd5e1; display: block; margin-bottom: 16px;"></i>
                                            <p style="font-size: 16px; color: #64748b;">Aucun événement enregistré</p>
                                            <p style="font-size: 13px; color: #94a3b8;">Cliquez sur "Nouvel événement" pour en créer un</p>
                                        </td>
                                    </tr>
                                <?php else : ?>
                                    <?php foreach ($evenements as $index => $evenement) : ?>
                                        <tr data-type="<?php echo isset($evenement['type_evenement']) ? $evenement['type_evenement'] : ''; ?>"
                                            data-status="<?php echo isset($evenement['statut']) ? $evenement['statut'] : ''; ?>"
                                            data-date="<?php echo isset($evenement['date_debut']) ? $evenement['date_debut'] : ''; ?>"
                                            data-id="<?php echo isset($evenement['id']) ? $evenement['id'] : ''; ?>">

                                            <td><?php echo $index + 1; ?></td>

                                            <td>
                                                <div style="display: flex; align-items: center; gap: 10px;">
                                                    <span style="display: inline-block; width: 10px; height: 10px; border-radius: 50%; background: <?php echo isset($evenement['couleur']) ? $evenement['couleur'] : '#3b82f6'; ?>;"></span>
                                                    <div>
                                                        <strong><?php echo isset($evenement['titre']) ? htmlspecialchars($evenement['titre']) : ''; ?></strong>
                                                        <?php if (!empty($evenement['description'])) : ?>
                                                            <br>
                                                            <small style="color: #94a3b8; font-size: 11px;">
                                                                <?php echo isset($evenement['description']) ? htmlspecialchars(substr($evenement['description'], 0, 40)) : ''; ?>...
                                                            </small>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            ...
                                            <td>
                                                    <span class="badge-type <?php echo isset($evenement['type_evenement']) ? $this->evenements_model->get_type_badge($evenement['type_evenement']) : 'autre'; ?>">
                                                        <?php echo isset($types[$evenement['type_evenement']]) ? $types[$evenement['type_evenement']] : $evenement['type_evenement']; ?>
                                                    </span>
                                            </td>

                                            <td>
                                                <?php echo !empty($evenement['date_debut']) ? date('d/m/Y', strtotime($evenement['date_debut'])) : ''; ?>
                                                <?php if (!empty($evenement['heure_debut'])) : ?>
                                                    <br>
                                                    <small style="color: #94a3b8; font-size: 11px;">
                                                        <i class="fa fa-clock-o"></i> <?php echo substr($evenement['heure_debut'], 0, 5); ?>
                                                    </small>
                                                <?php endif; ?>
                                            </td>

                                            <td><?php echo isset($evenement['lieu']) ? htmlspecialchars($evenement['lieu']) : '—'; ?></td>

                                            <td>
                                                    <span style="font-weight: 600; color: #3b82f6;">
                                                        <?php echo isset($evenement['nombre_participants']) ? $evenement['nombre_participants'] : 0; ?>
                                                    </span>
                                            </td>

                                            <td>
                                                    <span class="badge-status <?php echo isset($evenement['statut']) ? $this->evenements_model->get_status_badge($evenement['statut']) : 'planifie'; ?>">
                                                        <?php echo isset($statuses[$evenement['statut']]) ? $statuses[$evenement['statut']] : $evenement['statut']; ?>
                                                    </span>
                                            </td>
                                            ...
                                            <td style="text-align: center;">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu actions-menu dropdown-menu-right">
                                                        <li>
                                                            <a onclick="viewEvenement(<?php echo isset($evenement['id']) ? $evenement['id'] : 0; ?>)" style="cursor: pointer;">
                                                                <i class="fa fa-eye" style="color: #8b5cf6;"></i> Voir détails
                                                            </a>
                                                        </li>
                                                        <li role="separator" class="divider"></li>
                                                        <li>
                                                            <a onclick="openEditModal(<?php echo isset($evenement['id']) ? $evenement['id'] : 0; ?>)">
                                                                <i class="fa fa-pencil" style="color: #3b82f6;"></i> Modifier
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#" class="text-danger" onclick="confirmDelete(event, <?php echo isset($evenement['id']) ? $evenement['id'] : 0; ?>, '<?php echo isset($evenement['titre']) ? htmlspecialchars($evenement['titre']) : ''; ?>')">
...
<!-- ===== MODAL FORMULAIRE ===== -->
<div id="evenementFormModal" class="modal fade modal-chic" role="dialog">
    <div class="modal-dialog modal-lg" style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <h4 id="formModalTitle" style="margin: 0; color: white; font-size: 18px; font-weight: 600;">
                        ...
                        <span id="formTitleText">Nouvel événement</span>
                    </h4>
            ...
            <form id="evenementForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-7">
                            <div style="background: #f8fafc; padding: 15px; border-radius: 6px; margin-bottom: 16px;">
                                <h5 style="margin: 0 0 12px 0; color: #1e293b; font-size: 13px; font-weight: 600; border-bottom: 2px solid #e2e8f0; padding-bottom: 6px;">
                                    <i class="fa fa-info-circle" style="margin-right: 8px; color: #3B82F6;"></i> INFORMATIONS
                                </h5>

                                <div class="form-group" style="margin-bottom: 12px;">
                                    <label style="font-weight: 600; font-size: 12px; color: #334155;">Titre <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="edit_titre" name="titre" placeholder="Titre de l'événement" style="height: 38px; font-size: 13px;" required>
                                </div>

                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Type <span class="text-danger">*</span></label>
                                            <select class="form-control" id="edit_type" name="type_evenement" style="height: 38px; font-size: 13px;" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Date début <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control date" id="edit_date_debut" name="date_debut" readonly required style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Date fin</label>
                                            <input type="text" class="form-control date" id="edit_date_fin" name="date_fin" readonly style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Heure début</label>
                                            <input type="time" class="form-control" id="edit_heure_debut" name="heure_debut" style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Heure fin</label>
                                            <input type="time" class="form-control" id="edit_heure_fin" name="heure_fin" style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group" style="margin-bottom: 12px;">
                                    ...
                                    <textarea class="form-control" id="edit_description" name="description" rows="2" placeholder="Description de l'événement..." style="font-size: 13px; resize: vertical; min-height: 50px;"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div style="background: #eff6ff; padding: 15px; border-radius: 6px; border-left: 4px solid #3B82F6; margin-bottom: 16px;">
                                <h5 style="margin: 0 0 12px 0; color: #1e293b; font-size: 13px; font-weight: 600; border-bottom: 2px solid #dbeafe; padding-bottom: 6px;">
                                    <i class="fa fa-map-marker" style="margin-right: 8px; color: #3B82F6;"></i> LIEU & ORGANISATEUR
                                </h5>

                                <div class="form-group" style="margin-bottom: 12px;">
                                    <label style="font-weight: 600; font-size: 12px; color: #334155;">Lieu</label>
                                    <input type="text" class="form-control" id="edit_lieu" name="lieu" placeholder="Lieu de l'événement" style="height: 38px; font-size: 13px;">
                                </div>

                                <div class="form-group" style="margin-bottom: 12px;">
                                    <label style="font-weight: 600; font-size: 12px; color: #334155;">Adresse</label>
                                    <input type="text" class="form-control" id="edit_adresse" name="adresse" placeholder="Adresse complète" style="height: 38px; font-size: 13px;">
                                </div>

                                <div class="form-group" style="margin-bottom: 12px;">
                                    <label style="font-weight: 600; font-size: 12px; color: #334155;">Organisateur</label>
                                    <input type="text" class="form-control" id="edit_organisateur" name="organisateur" placeholder="Nom de l'organisateur" style="height: 38px; font-size: 13px;">
                                </div>

                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Contact</label>
                                            <input type="text" class="form-control" id="edit_contact" name="contact_organisateur" placeholder="Téléphone" style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Email</label>
                                            <input type="email" class="form-control" id="edit_email" name="email_organisateur" placeholder="Email" style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <!-- Participants et image -->
                            <div style="background: #f0fdf4; padding: 15px; border-radius: 6px; border-left: 4px solid #10b981; margin-bottom: 16px;">
                                <h5 style="margin: 0 0 12px 0; color: #1e293b; font-size: 13px; font-weight: 600; border-bottom: 2px solid #dcfce7; padding-bottom: 6px;">
                                    <i class="fa fa-users" style="margin-right: 8px; color: #10b981;"></i> PARTICIPANTS & IMAGE
                                </h5>

                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Nombre participants</label>
                                ...
                                <div class="form-group" style="margin-bottom: 12px;">
                                    <label style="font-weight: 600; font-size: 12px; color: #334155;">Liste des participants</label>
                                ...
                                <div class="form-group" style="margin-bottom: 0;">
                                    <label style="font-weight: 600; font-size: 12px; color: #334155;">
                                        <i class="fa fa-image"></i> Image de l'événement
                                    </label>
                                    <input type="file" class="form-control" id="edit_image" name="image" accept="image/*" style="height: 38px; padding: 4px 8px; font-size: 12px;">
                                    <small style="color: #94a3b8; font-size: 11px;">Formats: JPG, PNG, GIF | Max: 2MB</small>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- ===== MODAL DÉTAILS ===== -->
<div id="evenementDetailsModal" class="modal fade modal-chic" role="dialog">
    <div class="modal-dialog modal-lg" style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-header" style="background: linear-gradient(135deg, #1e293b, #0f172a); color: white; border-radius: 8px 8px 0 0;">
                <h4 style="margin: 0; color: white;">
                    <i class="fa fa-info-circle" style="color: #60a5fa;"></i> Détails de l'événement
                </h4>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#evenementFormModal').on('hidden.bs.modal', function() {
        ...
        $('#evenementForm').on('submit', function(e) {
            e.preventDefault();
    ...
    function openAddModal() {
        ...
        $('#formTitleText').text('Nouvel événement');
        $('#formModalSubtitle').text('Remplissez les informations de l\'événement');
        $('#formSubmitText').text('Enregistrer');
        $('#formSubmitBtn').removeClass('btn-warning').addClass('btn-success');
        $('#evenementForm').attr('action', '<?php echo site_url('admin/evenements/add_ajax'); ?>');
        $('#evenementForm')[0].reset();
        $('#edit_id').val('');
        $('#edit_statut').val('planifie');
        $('#edit_type').val('');
    ...
    function openEditModal(id) {
        ...
        Swal.fire({
            title: 'Chargement...',
            text: 'Récupération des données de l\'événement',
            icon: 'info',
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/evenements/get_data/' + id,
            type: 'GET',
            dataType: 'json',
            timeout: 10000,
    ...
    function fillEditForm(data) {
        ...
        $('#formTitleText').text('Modifier l\'événement');
        ...
        $('#evenementForm').attr('action', '<?php echo site_url('admin/evenements/update_ajax'); ?>');

        $('#edit_id').val(data.id);
        $('#edit_titre').val(data.titre || '');
        $('#edit_type').val(data.type_evenement || '');
        $('#edit_description').val(data.description || '');
        $('#edit_lieu').val(data.lieu || '');
        $('#edit_adresse').val(data.adresse || '');
        $('#edit_organisateur').val(data.organisateur || '');
        $('#edit_contact').val(data.contact_organisateur || '');
        $('#edit_email').val(data.email_organisateur || '');
        $('#edit_participants').val(data.nombre_participants || 0);
        $('#edit_liste_participants').val(data.participants || '');
        $('#edit_couleur').val(data.couleur || '#3b82f6');
        $('#edit_statut').val(data.statut || 'planifie');

        if (data.date_debut) {
            $('#edit_date_debut').val(formatDate(data.date_debut));
        }
        if (data.date_fin) {
            $('#edit_date_fin').val(formatDate(data.date_fin));
        }
    ...
    function submitAddForm(form) {
        ...
        $.ajax({
            url: '<?php echo site_url('admin/evenements/add_ajax'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            processData: false,
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    showSuccess(response.message || 'Événement ajouté avec succès');
    ...
    function submitEditForm(form) {
        ...
        $.ajax({
            url: '<?php echo site_url('admin/evenements/update_ajax'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            processData: false,
            ...
            success: function(response) {
                ...
                if (response.success) {
                    $('#evenementFormModal').modal('hide');
                    showSuccess(response.message || 'Événement mis à jour avec succès');
                    setTimeout(function() { location.reload(); }, 1500);
                } else {
    ...
    function validateForm() {
        ...
        if (type === '') {
            ...
            isValid = false;
            showError('Veuillez sélectionner le type');
            return false;
        }

        var date_debut = $('#edit_date_debut').val();
        if (date_debut === '' || date_debut === 'dd/mm/yyyy') {
            $('#edit_date_debut').css('border-color', '#ef4444');
    ...
    function applyFilters() {
        ...
        const rows = document.querySelectorAll('#evenementsTableBody tr');
        let visibleCount = 0;
        ...
        if (!noResult) {
            ...
            noResult.innerHTML = '<td colspan="8" class="text-center text-muted" style="padding:40px 0;">Aucun événement ne correspond aux filtres</td>';
            document.querySelector('#evenementsTableBody').appendChild(noResult);
        }
    ...
    function exportData(type) {
        ...
        const params = `?type=${encodeURIComponent(filterType)}&statut=${encodeURIComponent(filterStatus)}&date_from=${encodeURIComponent(dateFrom)}&date_to=${encodeURIComponent(dateTo)}`;

        showSpinner();

        var url = '<?php echo base_url("admin/evenements/export_"); ?>' + type + params;
    ...
    function confirmDelete(event, id, titre) {
        ...
        Swal.fire({
            ...
            text: 'Supprimer définitivement l\'événement "' + titre + '" ?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                showSpinner();
                window.location.href = '<?php echo base_url("admin/evenements/delete/"); ?>' + id;
            }
        });
    }
    ...
    // VOIR DÉTAILS                               //
    // ========================================== //
    function viewEvenement(id) {
        showSpinner();
        $.ajax({
            url: '<?php echo base_url(); ?>admin/evenements/details/' + id,
            success: function(result) {
                hideSpinner();
                $('#detailsContent').html(result);
                $('#evenementDetailsModal').modal('show');
            },
            error: function() {
                hideSpinner();
