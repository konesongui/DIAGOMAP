<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-sitemap"></i>Suivi de projets</h1>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> Suivi de projets</h3>
                    </div>
                    <div class="col-md-12">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <form id="formadd" method="post" class="ptt10">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="pwd">Code du projet</label><small class="req"> *</small>
