                                    ...
                                    <?php else: ?>
                                        <?php foreach ($enquiry_list as $value): ?>
                                            ...
                                            $status_styles = [
                                                ...
                                                'active' => ['label' => 'Approuvé', 'color' => '#4caf50'],
                                                'passive' => ['label' => 'Rejeté', 'color' => '#f44337'],
                                                'default' => ['label' => ucfirst($status), 'color' => '#9e9e9e']
                                            ];
...
<script>
    // Modifiez la partie DataTable dans le script
    $(document).ready(function () {
        ...
        // Initialisation de DataTable avec les boutons en haut
        if ($.fn.DataTable) {
            $("#enquirytable").DataTable({
                ...
                // Configuration du DOM pour placer les boutons en haut
                dom: "<'row'<'col-sm-6'l><'col-sm-6'f>>" +
                    "<'row'<'col-sm-12'B>>" +           // Boutons au milieu après la recherche
                    "<'row'<'col-sm-12'tr>>" +           // Tableau
                    "<'row'<'col-sm-5'i><'col-sm-7'p>>", // Informations et pagination en bas
                buttons: [
                    {
                        extend: 'copyHtml5',
                ...
                // Ajouter un en-tête personnalisé avant les boutons
                initComplete: function() {
                    // Ajouter un titre au-dessus des boutons
                    $('.dt-buttons').before(
    ...
    function getRecord(id, status) {
        $.ajax({
            ...
            success: function (result) {
                ...
                // Réinitialiser les datepickers dans le modal d'édition
