<!-- ============================================================
     PAGE : Gestion des groupes et cellules
     DESCRIPTION : Interface moderne pour la gestion des groupes
     ============================================================ -->
...
<style>
    ...
    .badge-status.suspendu { background: #fef2f2; color: #991b1b; }
    ...
    .badge-type.groupe { background: #dbeafe; color: #1d4ed8; }
    .badge-type.cellule { background: #d1fae5; color: #059669; }
            ...
            <div class="col-md-12">
                <div class="card-modern">
                    <div class="card-header">
                        <h3>
                            <i class="fa fa-group"></i> Groupes & Cellules
                        ...
                        <div class="d-flex align-items-center gap-3" style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                            ...
                            <button type="button" class="btn-add-modern" onclick="openAddModal()">
                                <i class="fa fa-plus-circle" style="margin-right: 6px;"></i> Nouveau groupe
                            </button>
                        </div>
                    </div>
                    ...
                    <div style="padding: 20px 24px 0;">
                        <div class="stats-grid">
                            <div class="stat-card">
                                <div class="stat-info">
                                    <h4><i class="fa fa-group"></i> Total</h4>
                            ...
                            <div class="stat-card" style="border-left-color: #3b82f6;">
                                <div class="stat-info">
                                    <h4><i class="fa fa-users" style="color:#3b82f6;"></i> Membres</h4>
                            ...
                            <div class="stat-card" style="border-left-color: #8b5cf6;">
                                <div class="stat-info">
                                    <h4><i class="fa fa-venus-mars" style="color:#8b5cf6;"></i> Groupes/Cellules</h4>
                                    <p class="number">
                                        <?php echo isset($stats['type_groupe']) ? $stats['type_groupe'] : 0; ?>
                                        <span style="font-size: 12px; color: #94a3b8;">Groupes</span>
                                        /
                                        <?php echo isset($stats['type_cellule']) ? $stats['type_cellule'] : 0; ?>
                                        <span style="font-size: 12px; color: #94a3b8;">Cellules</span>
                                    </p>
                                </div>
                                <div class="stat-icon"><i class="fa fa-venus-mars"></i></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="filter-bar">
                            ...
                            <div class="filter-group">
                                <label><i class="fa fa-map-marker"></i> Quartier :</label>
                                <select id="filterQuartier" onchange="applyFilters()">
                                    <option value="">Tous</option>
                                    <?php if (isset($quartiers) && is_array($quartiers)) : ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-modern" id="groupesTable">
                                <thead>
                                <tr>
                                    <th style="width: 5%;">#</th>
                                ...
                                <?php if (empty($groupes)) : ?>
                                    <tr>
                                        <td colspan="8" class="text-center text-muted" style="padding: 60px 0;">
                                            <i class="fa fa-group" style="font-size: 48px; color: #cbd5e1; display: block; margin-bottom: 16px;"></i>
                                            <p style="font-size: 16px; color: #64748b;">Aucun groupe ou cellule enregistré</p>
                                            <p style="font-size: 13px; color: #94a3b8;">Cliquez sur "Nouveau groupe" pour en créer un</p>
                                        </td>
                                    </tr>
                                <?php else : ?>
                                    <?php foreach ($groupes as $index => $groupe) : ?>
                                        <tr data-type="<?php echo isset($groupe['type']) ? $groupe['type'] : ''; ?>"
                                            data-status="<?php echo isset($groupe['statut']) ? $groupe['statut'] : ''; ?>"
                                            data-quartier="<?php echo isset($groupe['quartier']) ? $groupe['quartier'] : ''; ?>"
                                            data-id="<?php echo isset($groupe['id']) ? $groupe['id'] : ''; ?>">

                                            <td><?php echo $index + 1; ?></td>

                                            <td>
                                                <strong><?php echo isset($groupe['nom']) ? htmlspecialchars($groupe['nom']) : ''; ?></strong>
                                                <?php if (!empty($groupe['description'])) : ?>
                                                    <br>
                                                    <small style="color: #94a3b8; font-size: 11px;">
                                                        <?php echo isset($groupe['description']) ? htmlspecialchars(substr($groupe['description'], 0, 40)) : ''; ?>...
                                                    </small>
                                                <?php endif; ?>
                                            </td>

                                            <td>
                                                    <span class="badge-type <?php echo isset($groupe['type']) ? $groupe['type'] : 'cellule'; ?>">
                                                        <?php echo isset($types[$groupe['type']]) ? $types[$groupe['type']] : $groupe['type']; ?>
                                                    </span>
                                            </td>

                                            <td><?php echo isset($groupe['responsable']) ? htmlspecialchars($groupe['responsable']) : '—'; ?></td>

                                            <td>
                                                    <span style="font-weight: 600; color: #3b82f6;">
                                                        <?php echo isset($groupe['nombre_membres']) ? $groupe['nombre_membres'] : 0; ?>
                                                    </span>
                                            </td>

                                            <td>
                                                <?php if (!empty($groupe['quartier'])) : ?>
                                                    <span style="background: #f1f5f9; padding: 2px 10px; border-radius: 4px; font-size: 11px; color: #475569;">
                                                            <i class="fa fa-map-marker"></i> <?php echo isset($groupe['quartier']) ? htmlspecialchars($groupe['quartier']) : ''; ?>
                                                        </span>
                                                <?php else : ?>
                                            ...
                                            <td>
                                                    <span class="badge-status <?php echo isset($groupe['statut']) ? $this->groupes_model->get_status_badge($groupe['statut']) : 'actif'; ?>">
                                                        <?php echo isset($statuses[$groupe['statut']]) ? $statuses[$groupe['statut']] : $groupe['statut']; ?>
                                                    </span>
                                            </td>
                                            ...
                                            <td style="text-align: center;">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu actions-menu dropdown-menu-right">
                                                        <li>
                                                            <a onclick="viewGroupe(<?php echo isset($groupe['id']) ? $groupe['id'] : 0; ?>)" style="cursor: pointer;">
                                                                <i class="fa fa-eye" style="color: #8b5cf6;"></i> Voir détails
                                                            </a>
                                                        </li>
                                                        <li role="separator" class="divider"></li>
                                                        <li>
                                                            <a onclick="openEditModal(<?php echo isset($groupe['id']) ? $groupe['id'] : 0; ?>)">
                                                                <i class="fa fa-pencil" style="color: #3b82f6;"></i> Modifier
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#" class="text-danger" onclick="confirmDelete(event, <?php echo isset($groupe['id']) ? $groupe['id'] : 0; ?>, '<?php echo isset($groupe['nom']) ? htmlspecialchars($groupe['nom']) : ''; ?>')">
...
<!-- ===== MODAL FORMULAIRE ===== -->
<div id="groupeFormModal" class="modal fade modal-chic" role="dialog">
            ...
            <div class="modal-header">
                <div>
                    <h4 id="formModalTitle" style="margin: 0; color: white; font-size: 18px; font-weight: 600;">
                        ...
                        <span id="formTitleText">Nouveau groupe</span>
                    </h4>
                        ...
                        <div class="col-md-6">
                            <div style="background: #f8fafc; padding: 15px; border-radius: 6px; margin-bottom: 16px;">
                                ...
                                <div class="form-group" style="margin-bottom: 12px;">
                                    <label style="font-weight: 600; font-size: 12px; color: #334155;">Nom du groupe <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="edit_nom" name="nom" placeholder="Nom du groupe" style="height: 38px; font-size: 13px;" required>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            ...
                                            <select class="form-control" id="edit_type" name="type" style="height: 38px; font-size: 13px;" required>
                                ...
                                <div class="form-group" style="margin-bottom: 12px;">
                                    ...
                                    <textarea class="form-control" id="edit_description" name="description" rows="2" placeholder="Description du groupe..." style="font-size: 13px; resize: vertical; min-height: 50px;"></textarea>
                                </div>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <!-- Responsable et réunion -->
                            <div style="background: #eff6ff; padding: 15px; border-radius: 6px; border-left: 4px solid #3B82F6; margin-bottom: 16px;">
                                <h5 style="margin: 0 0 12px 0; color: #1e293b; font-size: 13px; font-weight: 600; border-bottom: 2px solid #dbeafe; padding-bottom: 6px;">
                                    <i class="fa fa-user" style="margin-right: 8px; color: #3B82F6;"></i> RESPONSABLE & RÉUNION
                                </h5>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Jour réunion</label>
                                            <select class="form-control" id="edit_jour" name="jour_reunion" style="height: 38px; font-size: 13px;">
                                                <option value="">Sélectionner...</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            ...
                                            <input type="time" class="form-control" id="edit_heure" name="heure_reunion" style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group" style="margin-bottom: 12px;">
                                    <label style="font-weight: 600; font-size: 12px; color: #334155;">Lieu de réunion</label>
                                    <input type="text" class="form-control" id="edit_lieu" name="lieu_reunion" placeholder="Lieu de réunion" style="height: 38px; font-size: 13px;">
                                </div>

                                <div class="form-group" style="margin-bottom: 12px;">
                                    <label style="font-weight: 600; font-size: 12px; color: #334155;">Quartier</label>
                                    <input type="text" class="form-control" id="edit_quartier" name="quartier" placeholder="Quartier" style="height: 38px; font-size: 13px;">
                                </div>
                            </div>
                            ...
                            <div style="background: #f0fdf4; padding: 15px; border-radius: 6px; border-left: 4px solid #10b981;">
                                <h5 style="margin: 0 0 12px 0; color: #1e293b; font-size: 13px; font-weight: 600; border-bottom: 2px solid #dcfce7; padding-bottom: 6px;">
                                    <i class="fa fa-users" style="margin-right: 8px; color: #10b981;"></i> MEMBRES
                                </h5>

                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Nombre de membres</label>
                                            <input type="number" class="form-control" id="edit_membres" name="nombre_membres" placeholder="0" style="height: 38px; font-size: 13px;" min="0">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Liste des membres</label>
                                            <input type="text" class="form-control" id="edit_liste_membres" name="membres" placeholder="Noms séparés par des virgules" style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!-- ===== MODAL DÉTAILS ===== -->
<div id="groupeDetailsModal" class="modal fade modal-chic" role="dialog">
    <div class="modal-dialog modal-lg" style="max-width: 800px;">
        <div class="modal-content">
            <div class="modal-header" style="background: linear-gradient(135deg, #1e293b, #0f172a); color: white; border-radius: 8px 8px 0 0;">
                <h4 style="margin: 0; color: white;">
                    <i class="fa fa-info-circle" style="color: #60a5fa;"></i> Détails du groupe
                </h4>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#groupeFormModal').on('hidden.bs.modal', function() {
            $('#groupeForm')[0].reset();
            $('#edit_id').val('');
        ...
        $('#filterType, #filterStatus, #filterQuartier').on('change', function() {
            applyFilters();
        });
    });
    ...
    function openAddModal() {
        ...
        $('#formTitleText').text('Nouveau groupe');
        $('#formModalSubtitle').text('Remplissez les informations du groupe');
        $('#formSubmitText').text('Enregistrer');
        $('#formSubmitBtn').removeClass('btn-warning').addClass('btn-success');
        $('#groupeForm').attr('action', '<?php echo site_url('admin/groupes/add_ajax'); ?>');
        $('#groupeForm')[0].reset();
        $('#edit_id').val('');
        $('#edit_statut').val('actif');
        $('#edit_type').val('');
    ...
    function openEditModal(id) {
        ...
        Swal.fire({
            title: 'Chargement...',
            text: 'Récupération des données du groupe',
            icon: 'info',
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/groupes/get_data/' + id,
            type: 'GET',
            dataType: 'json',
            timeout: 10000,
    ...
    function fillEditForm(data) {
        ...
        $('#formTitleText').text('Modifier le groupe');
        ...
        $('#groupeForm').attr('action', '<?php echo site_url('admin/groupes/update_ajax'); ?>');
        ...
        $('#edit_jour').val(data.jour_reunion || '');
        $('#edit_heure').val(data.heure_reunion || '');
        $('#edit_lieu').val(data.lieu_reunion || '');
        $('#edit_quartier').val(data.quartier || '');
        $('#edit_membres').val(data.nombre_membres || 0);
        $('#edit_liste_membres').val(data.membres || '');
    ...
    function submitAddForm(form) {
        ...
        $.ajax({
            url: '<?php echo site_url('admin/groupes/add_ajax'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            processData: false,
            ...
            success: function(response) {
                hideSpinner();
                if (response.success) {
                    $('#groupeFormModal').modal('hide');
                    showSuccess(response.message || 'Groupe ajouté avec succès');
    ...
    function submitEditForm(form) {
        ...
        $.ajax({
            url: '<?php echo site_url('admin/groupes/update_ajax'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            processData: false,
            ...
            success: function(response) {
                ...
                if (response.success) {
                    $('#groupeFormModal').modal('hide');
                    showSuccess(response.message || 'Groupe mis à jour avec succès');
                    setTimeout(function() { location.reload(); }, 1500);
                } else {
    ...
    function validateForm() {
        ...
        if (nom === '') {
            ...
            isValid = false;
            showError('Veuillez renseigner le nom du groupe');
            return false;
        }
    ...
    function applyFilters() {
        ...
        const quartier = document.getElementById('filterQuartier').value;
        ...
        rows.forEach(row => {
            ...
            if (quartier && rowQuartier !== quartier) show = false;
        ...
        if (!noResult) {
            ...
            noResult.innerHTML = '<td colspan="8" class="text-center text-muted" style="padding:40px 0;">Aucun groupe ne correspond aux filtres</td>';
            document.querySelector('#groupesTableBody').appendChild(noResult);
        }
    ...
    function exportData(type) {
        ...
        const params = `?type=${encodeURIComponent(filterType)}&statut=${encodeURIComponent(filterStatus)}`;

        showSpinner();

        var url = '<?php echo base_url("admin/groupes/export_"); ?>' + type + params;
    ...
    function confirmDelete(event, id, nom) {
        ...
        Swal.fire({
            ...
            text: 'Supprimer définitivement le groupe "' + nom + '" ?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                showSpinner();
                window.location.href = '<?php echo base_url("admin/groupes/delete/"); ?>' + id;
            }
        });
    }
    ...
    // VOIR DÉTAILS                               //
    // ========================================== //
    function viewGroupe(id) {
        showSpinner();
        $.ajax({
            url: '<?php echo base_url(); ?>admin/groupes/details/' + id,
