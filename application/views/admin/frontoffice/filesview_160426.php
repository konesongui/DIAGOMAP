                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Ajouter un courier</h3>
                        </div><!-- /.box-header -->
                        <form id="form1" action="<?php echo site_url('admin/files') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Type de courier</label><small class="req"> *</small>
...
if ($this->rbac->hasPrivilege('file', 'can_add')) {
    echo "8";
} else {
    echo "12";
}
?>">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Liste des couriers</h3>
