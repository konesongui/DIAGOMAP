            ...
            <div class="row">
               ...
               <!-- <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        <select name="assigne[]" class="form-control" multiple>
                            <option value=""><?php echo $this->lang->line('select') ?></option>
                            <?php foreach ($stff_list as $key => $stff_list_value) { ?>
                                <option value="<?php echo $stff_list_value['id']; ?>">
                                    <?php echo $stff_list_value['name'].' '.$stff_list_value['surname']; ?>
                                </option>
                            <?php } ?>
                        </select>
                        <small class="text-muted">Maintenez CTRL (Windows) ou CMD (Mac) pour sélectionner plusieurs employés</small>
