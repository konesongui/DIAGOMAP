<div class="content-wrapper" style="min-height: 348px;">
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('courier_envoyer', 'can_add')) { ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add'); ?> un courier</h3>
                        </div><!-- /.box-header -->
                        <form id="form1" action="<?php echo site_url('admin/dispatch') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="pwd">Nom</label>  <small class="req"> *</small>
            ...
            if ($this->rbac->hasPrivilege('courier_envoyer', 'can_add')) {
                echo "8";
            } else {
                echo "12";
            }
            ?>">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('list'); ?> des couriers</h3>
                                    ...
                                    foreach ($DispatchList as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"><?php
                                                if ($value->type =="Envoi")
                                                {
                                                    echo "<h6><span class='label label-warning' style='background-color: #ff9801 !important; border-radius: 2px'>Envoyé<span/></h6>";
                                                }
                                                else{
                                                    echo "<h6><span class='label label-warning' style='background-color: #66aa18 !important; border-radius: 2px'>Reçu<span/></h6>";
                                                }
                                                ; ?></td>
                                            <td class="mailbox-date pull-right white-space-nowrap">
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('courier_envoyer', 'can_edit')) { ?>
                                                ...
                                                if ($this->rbac->hasPrivilege('courier_envoyer', 'can_delete')) {
                                                    ?>
