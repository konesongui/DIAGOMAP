<div class="content-wrapper" style="min-height: 348px;">  
    ...
    <section class="content">       
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('visiteurs', 'can_add') || $this->rbac->hasPrivilege('visiteurs', 'can_edit')) { ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
            ...
            if ($this->rbac->hasPrivilege('visiteurs', 'can_add') || $this->rbac->hasPrivilege('visiteurs', 'can_edit')) {
                echo "8";
            } else {
                echo "12";
            }
