<!-- ============================================================
     PAGE : Gestion des membres d'église
     DESCRIPTION : Interface moderne pour la gestion des membres
     ============================================================ -->
                ...
                <div class="card-modern">
                    <div class="card-header">
                        ...
                        <div class="d-flex align-items-center gap-3" style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                            ...
                            <button type="button" class="btn-add-modern" onclick="openAddModal()">
                                <i class="fa fa-plus-circle" style="margin-right: 6px;"></i> Nouveau membre
                            </button>
                        </div>
                    </div>
                    ...
                    <div style="padding: 20px 24px 0;">
                        <div class="stats-grid">
                            <div class="stat-card">
                                <div class="stat-info">
                                    <h4><i class="fa fa-users"></i> Total</h4>
                            ...
                            <div class="stat-card" style="border-left-color: #8b5cf6;">
                                <div class="stat-info">
                                    <h4><i class="fa fa-cross" style="color:#8b5cf6;"></i> Baptêmes</h4>
                                    <p class="number"><?php
                                        $baptises = 0;
                                        if (!empty($membres)) {
                                            foreach ($membres as $m) {
                                                if (!empty($m['date_bapteme'])) $baptises++;
                                            }
                                        }
                                        echo $baptises;
                                        ?></p>
                    ...
                    <div class="card-body">
                        ...
                        <div class="filter-bar">
                            ...
                            <div class="filter-group">
                                <label><i class="fa fa-tag"></i> Rôle :</label>
                        ...
                        <div class="table-responsive">
                            <table class="table table-modern" id="membresTable">
                                <thead>
                                <tr>
                                ...
                                <?php if (empty($membres)) : ?>
                                    <tr>
                                        <td colspan="9" class="text-center text-muted" style="padding: 60px 0;">
                                            ...
                                            <p style="font-size: 16px; color: #64748b;">Aucun membre enregistré</p>
                                            <p style="font-size: 13px; color: #94a3b8;">Cliquez sur "Nouveau membre" pour en ajouter un</p>
                                        </td>
                                    </tr>
                                <?php else : ?>
                                    <?php foreach ($membres as $index => $membre) : ?>
                                        <tr data-status="<?php echo isset($membre['statut_membre']) ? $membre['statut_membre'] : ''; ?>"
                                            data-role="<?php echo isset($membre['role']) ? $membre['role'] : ''; ?>"
                                            data-sexe="<?php echo isset($membre['sexe']) ? $membre['sexe'] : ''; ?>"
                                            data-id="<?php echo isset($membre['id']) ? $membre['id'] : ''; ?>">

                                            <td>
                                                    <span style="background: #f1f5f9; padding: 2px 10px; border-radius: 4px; font-size: 11px; color: #475569;">
                                                        <?php echo isset($membre['code_membre']) ? htmlspecialchars($membre['code_membre']) : ''; ?>
                                                    </span>
                                            </td>
                                            ...
                                            <td>
                                                <div style="display: flex; align-items: center; gap: 8px;">
                                                    ...
                                                    <?php else : ?>
                                                        <div style="width: 32px; height: 32px; border-radius: 50%; background: #f1f5f9; display: flex; align-items: center; justify-content: center; color: #94a3b8; font-size: 14px; font-weight: 600; border: 2px solid var(--border-light);">
                                                            <?php echo isset($membre['nom']) ? strtoupper(substr($membre['nom'], 0, 1)) : '?'; ?>
                                                        </div>
                                                    <?php endif; ?>
                                                    <strong><?php echo isset($membre['nom']) ? htmlspecialchars($membre['nom']) : ''; ?></strong>
                                                </div>
                                            </td>

                                            <td><?php echo isset($membre['prenom']) ? htmlspecialchars($membre['prenom']) : ''; ?></td>

                                            <td>
                                                    <span style="font-weight: 600; color: <?php echo $membre['sexe'] == 'M' ? '#3b82f6' : '#f59e0b'; ?>;">
                                            ...
                                            <td>
                                                    <span class="badge-role <?php echo isset($membre['role']) ? $this->membres_model->get_role_badge($membre['role']) : 'membre'; ?>">
                                                        <?php echo isset($roles[$membre['role']]) ? $roles[$membre['role']] : $membre['role']; ?>
                                                    </span>
                                            </td>
                                            ...
                                            <td>
                                                    <span class="badge-status <?php echo isset($membre['statut_membre']) ? $this->membres_model->get_status_badge($membre['statut_membre']) : 'actif'; ?>">
                                                        <?php echo isset($statuses[$membre['statut_membre']]) ? $statuses[$membre['statut_membre']] : $membre['statut_membre']; ?>
                                                    </span>
                                            </td>

                                            <td>
                                                <?php if (!empty($membre['groupe_cellule'])) : ?>
                                                    <span style="background: #f1f5f9; padding: 2px 10px; border-radius: 4px; font-size: 11px; color: #475569;">
                                            ...
                                            <td style="text-align: center;">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu actions-menu dropdown-menu-right">
                                                        <li>
                                                            <a onclick="viewMembre(<?php echo isset($membre['id']) ? $membre['id'] : 0; ?>)" style="cursor: pointer;">
                                                                <i class="fa fa-eye" style="color: #8b5cf6;"></i> Voir détails
                                                            </a>
                                                        </li>
                                                        <li role="separator" class="divider"></li>
                                                        <li>
                                                            <a onclick="openEditModal(<?php echo isset($membre['id']) ? $membre['id'] : 0; ?>)">
                                                                <i class="fa fa-pencil" style="color: #3b82f6;"></i> Modifier
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#" class="text-danger" onclick="confirmDelete(event, <?php echo isset($membre['id']) ? $membre['id'] : 0; ?>, '<?php echo isset($membre['nom']) ? htmlspecialchars($membre['nom']) . ' ' . htmlspecialchars($membre['prenom']) : ''; ?>')">
...
<!-- ===== MODAL FORMULAIRE ===== -->
<div id="membreFormModal" class="modal fade modal-chic" role="dialog">
    <div class="modal-dialog modal-lg" style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <h4 id="formModalTitle" style="margin: 0; color: white; font-size: 18px; font-weight: 600;">
                        ...
                        <span id="formTitleText">Nouveau membre</span>
                    </h4>
            ...
            <form id="membreForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-7">
                            ...
                            <div style="background: #f8fafc; padding: 15px; border-radius: 6px; margin-bottom: 16px;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Sexe <span class="text-danger">*</span></label>
                                            <select class="form-control" id="edit_sexe" name="sexe" style="height: 38px; font-size: 13px;" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Lieu naissance</label>
                                            <input type="text" class="form-control" id="edit_lieu_naissance" name="lieu_naissance" placeholder="Lieu de naissance" style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Nationalité</label>
                                            <input type="text" class="form-control" id="edit_nationalite" name="nationalite" placeholder="Nationalité" style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            ...
                                            <input type="text" class="form-control" id="edit_profession" name="profession" placeholder="Profession" style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                        ...
                        <div class="col-md-5">
                            ...
                            <div style="background: #eff6ff; padding: 15px; border-radius: 6px; border-left: 4px solid #3B82F6; margin-bottom: 16px;">
                                <h5 style="margin: 0 0 12px 0; color: #1e293b; font-size: 13px; font-weight: 600; border-bottom: 2px solid #dbeafe; padding-bottom: 6px;">
                                    <i class="fa fa-church" style="margin-right: 8px; color: #3B82F6;"></i> VIE DE L'ÉGLISE
                                </h5>

                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Rôle</label>
                                            <select class="form-control" id="edit_role" name="role" style="height: 38px; font-size: 13px;">
                                                <?php if (isset($roles) && is_array($roles)) : ?>
                                                    <?php foreach ($roles as $key => $label) : ?>
                                                        <option value="<?php echo $key; ?>"><?php echo $label; ?></option>
                                                    <?php endforeach; ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            ...
                                            <select class="form-control" id="edit_statut" name="statut_membre" style="height: 38px; font-size: 13px;">
                                                <?php if (isset($statuses) && is_array($statuses)) : ?>
                                                    <?php foreach ($statuses as $key => $label) : ?>
                                                        <option value="<?php echo $key; ?>"><?php echo $label; ?></option>
                                                    <?php endforeach; ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Département</label>
                                            <input type="text" class="form-control" id="edit_departement" name="departement" placeholder="Département" style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Cellule</label>
                                            <input type="text" class="form-control" id="edit_cellule" name="groupe_cellule" placeholder="Groupe/cellule" style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Date baptême</label>
                                            <input type="text" class="form-control date" id="edit_date_bapteme" name="date_bapteme" readonly style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Date affiliation</label>
                                            <input type="text" class="form-control date" id="edit_date_affiliation" name="date_affiliation" readonly style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="background: #f0fdf4; padding: 15px; border-radius: 6px; border-left: 4px solid #10b981; margin-bottom: 16px;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Nom du conjoint</label>
                                            <input type="text" class="form-control" id="edit_conjoint" name="nom_conjoint" placeholder="Nom du conjoint" style="height: 38px; font-size: 13px;">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-bottom: 12px;">
                                            <label style="font-weight: 600; font-size: 12px; color: #334155;">Nombre d'enfants</label>
                                ...
                                <div class="form-group" style="margin-bottom: 0;">
                                    ...
                                    <textarea class="form-control" id="edit_remarques" name="remarques" rows="2" placeholder="Remarques..." style="font-size: 13px; resize: vertical;"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- ===== MODAL DÉTAILS ===== -->
<div id="membreDetailsModal" class="modal fade modal-chic" role="dialog">
    <div class="modal-dialog modal-lg" style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-header" style="background: linear-gradient(135deg, #1e293b, #0f172a); color: white; border-radius: 8px 8px 0 0;">
                <h4 style="margin: 0; color: white;">
                    <i class="fa fa-info-circle" style="color: #60a5fa;"></i> Détails du membre
                </h4>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#membreFormModal').on('hidden.bs.modal', function() {
            $('#membreForm')[0].reset();
            $('#edit_id').val('');
        ...
        $('#filterStatus, #filterRole, #filterSexe').on('change', function() {
            applyFilters();
        });
    });
    ...
    function openAddModal() {
        ...
        $('#formTitleText').text('Nouveau membre');
        $('#formModalSubtitle').text('Remplissez les informations du membre');
        $('#formSubmitText').text('Enregistrer');
        $('#formSubmitBtn').removeClass('btn-warning').addClass('btn-success');
        $('#membreForm').attr('action', '<?php echo site_url('admin/membres/add_ajax'); ?>');
        $('#membreForm')[0].reset();
        $('#edit_id').val('');
        $('#edit_statut').val('actif');
        $('#edit_role').val('membre');
        $('#photoPreview').html('<div class="photo-placeholder"><i class="fa fa-user"></i></div>');
        $('.text-danger').html('');
        $('#membreFormModal').modal('show');
    }
    ...
    function openEditModal(id) {
        ...
        Swal.fire({
            title: 'Chargement...',
            text: 'Récupération des données du membre',
            icon: 'info',
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/membres/get_data/' + id,
            type: 'GET',
            dataType: 'json',
            timeout: 10000,
    ...
    function fillEditForm(data) {
        ...
        $('#formTitleText').text('Modifier le membre');
        ...
        $('#membreForm').attr('action', '<?php echo site_url('admin/membres/update_ajax'); ?>');
        ...
        $('#edit_cellule').val(data.groupe_cellule);
        $('#edit_conjoint').val(data.nom_conjoint);
        $('#edit_enfants').val(data.nombre_enfants);
        $('#edit_statut').val(data.statut_membre);
        ...
        if (data.date_affiliation) {
            $('#edit_date_affiliation').val(formatDate(data.date_affiliation));
        }

        if (data.photo) {
            $('#photoPreview').html('<img src="<?php echo base_url('uploads/membres/'); ?>' + data.photo + '" style="width: 100%; height: 100%; object-fit: cover;">');
        }
    ...
    function submitAddForm(form) {
        ...
        $.ajax({
            url: '<?php echo site_url('admin/membres/add_ajax'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            processData: false,
            ...
            success: function(response) {
                hideSpinner();
                if (response.success) {
                    $('#membreFormModal').modal('hide');
                    showSuccess(response.message || 'Membre ajouté avec succès');
    ...
    function submitEditForm(form) {
        ...
        $.ajax({
            url: '<?php echo site_url('admin/membres/update_ajax'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            processData: false,
            ...
            success: function(response) {
                ...
                if (response.success) {
                    $('#membreFormModal').modal('hide');
                    showSuccess(response.message || 'Membre mis à jour avec succès');
                    setTimeout(function() { location.reload(); }, 1500);
                } else {
    ...
    function validateForm() {
        ...
        var sexe = $('#edit_sexe').val();
        if (sexe === '') {
            $('#edit_sexe').css('border-color', '#ef4444');
    ...
    function applyFilters() {
        ...
        const rows = document.querySelectorAll('#membresTableBody tr');
        let visibleCount = 0;
        ...
        if (!noResult) {
            ...
            noResult.innerHTML = '<td colspan="9" class="text-center text-muted" style="padding:40px 0;">Aucun membre ne correspond aux filtres</td>';
            document.querySelector('#membresTableBody').appendChild(noResult);
        }
    ...
    function exportData(type) {
        ...
        const params = `?statut=${encodeURIComponent(statut)}&role=${encodeURIComponent(role)}&sexe=${encodeURIComponent(sexe)}`;

        showSpinner();

        var url = '<?php echo base_url("admin/membres/export_"); ?>' + type + params;
    ...
    function confirmDelete(event, id, nom) {
        ...
        Swal.fire({
            ...
            text: 'Supprimer définitivement le membre "' + nom + '" ?',
            icon: 'warning',
    ...
    function viewMembre(id) {
        showSpinner();
        $.ajax({
            url: '<?php echo base_url(); ?>admin/membres/details/' + id,
            success: function(result) {
                hideSpinner();
                $('#detailsContent').html(result);
                $('#membreDetailsModal').modal('show');
            },
            error: function() {
                hideSpinner();
