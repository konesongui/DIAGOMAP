                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <!-- <div class="box-tools pull-right">
                            <a href="<?php echo base_url('admin/quotenostock/print/'.$quote['id']); ?>" class="btn btn-primary btn-sm" target="_blank">
                                <i class="fa fa-print"></i> Imprimer
                            </a>
                            <a href="<?php echo base_url('admin/quotenostock/sendEmail/'.$quote['id']); ?>" class="btn btn-info btn-sm">
