                ...
                <table cellpadding="0" cellspacing="0" width="100%" style="background: <?php echo $id_card[0]->header_color; ?>;">
                                ...
                                <tr>
                                    <td valign="top" style="text-align: center">
                                        <div style="color: #fff;position: relative; z-index: 1; text-align: center;vertical-align: top">
                                           <!-- <div class="sttext1" style="font-size: 10px;line-height: 5px;"><img style="vertical-align: middle; width: 30px;" src="<?php echo base_url('uploads/staff_id_card/logo/'.$id_card[0]->logo); ?>" width="25" height="30"> <?php echo $id_card[0]->school_name; ?>
                                            </div>-->
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td valign="top" style="background: #fff">
                            <table cellpadding="0" cellspacing="0" width="100%" style="margin-top: -80px; position: relative;z-index: 1;">
                                <tr>
                                    <td valign="top">
                                        <div class="stimg center-block">
                                            <img style="vertical-align: middle; width: 150px; border-radius: 8px; border:3px solid" src="<?php echo base_url('uploads/staff_id_card/logo/'.$id_card[0]->logo); ?>" <?php echo $id_card[0]->school_name; ?>
                                ...
                                <tr>
                                    <td valign="top" style="text-align: center;"><br/><br/>
                                        <h4 style="margin:0; text-transform: uppercase;font-weight: bold; margin-top: 10px; font-size: 50px; font-family: 'Arial Narrow'"> <?php echo $id_card[0]->school_name; ?>
                                           </h4>
                                        ...
                                        ?>
                                        <p style="font-size: 25px;text-align: justify;font-family: 'Arial Narrow';text-align: center;"><?php echo $id_card[0]->title ?></p>
                                        <span style="text-decoration: underline;font-size: 30px;text-align: justify;font-family: 'Arial Narrow';border: 0px solid black;"><?php echo $staff_value->name." ".$staff_value->surname; ?></span>
                                        <p style="font-size: 25px;text-align: justify;font-family: 'Arial Narrow'"><?php echo $id_card[0]->school_address; ?> </p>
                            ...
                            <table cellpadding="0" cellpadding="0" width="90%" align="center" style="background: #fff;padding: 5px 5px;display: block;width: 90%;margin:0 auto">
                                <tr>
                                    <td valign="top">
                                        ...
                                        <div class="signature"><span style="font-family: 'Arial Narrow';border: 0px solid black; font-size: 25px">Fait à Abidjan, le</span> <span style="font-size: 25px" id="datetime"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 25px;border: 0px solid black; ">Direction Générale</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url('uploads/staff_id_card/signature/'.$id_card[0]->sign_image); ?>" width="150" height="24" style="width: 150px;" /></div>
                                    </td>
                                </tr>
                  ...
                  <!--  <div style="bottom: 10px; position: absolute; width: 96%;">
                        <table style="width: 100%" collapse="0">
                            <tr>
                                <td class="text-center" colspan="7" style="border: 0px solid black; height: 5px; padding: 3px; text-align: center; font-size: 14px; font-family: 'Arial Narrow'">
                                    <b><em><?= strtoupper($sch_setting->address) ?><br/><?= strtoupper($sch_setting->rccm) ?>-<?= strtoupper($sch_setting->bank) ?>:  <?= strtoupper($sch_setting->compt_bank) ?><br/>Tèl: 0757918127</em></b>
                                </td>
                    ...
                    <!--<p><img src="<?= $barcode_url ?>" alt="Barcode"></p>-->
                ...
                <tr>
                        <td valign="top">
                            <div class="studenttop" style="background: <?php echo $id_card[0]->header_color ?>">
                                <div class="sttext1" style="text-align: center">
