        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <form role="form" action="<?php echo site_url('admin/generatestaffcertificate/search') ?>" method="post" class="">
                                        ...
                                        <select  id="id_card" name="id_card" class="form-control" >
                                            ...
                                            if (isset($idcardlist)) {
                                                foreach ($idcardlist as $idcardlist_value) {
                                                    ?>
                                                    <option value="<?php echo $idcardlist_value->id ?>" <?php if (set_value('id_card') == $idcardlist_value->id) echo "selected=selected" ?>><?php echo $idcardlist_value->school_name ?></option>
                                                <?php
                                                }
                                            }
                                            ?>
                ...
                if (isset($resultlist)) {
                    ?>
                    <form method="post" action="<?php echo base_url('admin/generatestaffcertificate/generatemultiple') ?>">
                        <div  class="" id="duefee">
