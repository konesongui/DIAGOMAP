...
<style>
    ...
    @media (max-width: 991px) {
        .box.box-primary > .box-header.with-border{ flex-direction:column; align-items:flex-start; }
        .box-tools{ width:100%; }
    }
    ...
    table.orderDatatable tbody tr:hover{ background:#FAFBFD; }
    table.orderDatatable tbody tr td:first-child{
    ...
    .pf-status-pending{ background:var(--pf-amber-soft); color:#8A6415; } .pf-status-pending::before{ background:var(--pf-amber); }
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <?php if (!$is_admin_user): ?>
                                <span class="badge bg-info" style="margin-right: 10px; padding: 8px;">
                                    <i class="fa fa-user"></i> Mes commandes uniquement
                                </span>
                            <?php else: ?>
                                <span class="badge bg-success" style="margin-right: 10px; padding: 8px;">
                                    <i class="fa fa-eye"></i> Vue administrateur (toutes les commandes)
                            ...
                            <!-- Bouton d'ajout si permission -->
                            <?php if ($this->rbac->hasPrivilege('order_item', 'can_add')): ?>
                               <!-- <a href="<?php echo site_url('admin/orderformitem/form') ?>" type="button" class="btn btn-primary btn-sm">
                                    <i class="fa fa-plus"></i> Ajouter un bon de commande
                                </a>-->
                            <?php endif; ?>
                        </div>
