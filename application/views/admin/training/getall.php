            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary" id="bklist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Liste des formations</h3><div class="pull-right">
                            <?php if ($this->rbac->hasPrivilege('formations', 'can_add')) {
                                ?>
                                <a href="<?php echo base_url() ?>admin/training">

                                    <button class="btn btn-primary btn-sm" autocomplete="off"><i class="fa fa-plus"></i> Ajouter une formation</button>
                                </a>
                            <?php }
                            ?>
...
<script>
    ...
    ( function ( $ ) {
        'use strict';
        $(document).ready(function () {
            initDatatable('book-list','admin/training/getbooklist',[],[],100);
        });
    } ( jQuery ) )
</script>