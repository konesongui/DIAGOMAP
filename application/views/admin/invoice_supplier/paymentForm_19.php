...
// Récupérer les BANQUES actives - MIS À JOUR selon votre structure de table
...
<form id="<?= $formID ?>">
    <div class="modal-body">
        ...
        <div class="row">
            <!-- Deuxième ligne - Méthode et Source -->
            <div class="col-md-6">
                <div class="form-group">
                    <label for="method">Méthode de paiement <span class="text-danger">*</span></label>
                    <select class="form-control" id="method" name="method" required onchange="toggleSourceFields()">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <!-- Champ CAISSE (visible par défaut pour espèces) -->
                    ...
                    <select class="form-control" id="caisse_id" name="caisse_id">
                        ...
                        <?php if (!empty($caisses)): ?>
                            <?php foreach ($caisses as $caisse): ?>
                                <option value="<?= $caisse['id'] ?>" data-type="caisse">
                    ...
                    <select class="form-control" id="banque_id" name="banque_id">
                        ...
                        <?php if (!empty($banques)): ?>
                            <?php foreach ($banques as $banque): ?>
                                <option value="<?= $banque['id'] ?>" data-type="banque">
                ...
                <!-- Champ caché pour stocker le type de source (caisse ou banque) -->
...
<script>
    $(function () {
        ...
        $('#paymentForm').submit(function(e){
            ...
            if (['cash','check','card'].includes(method)) {
                caisse_id = $('#caisse_id').val();
            } else {
                caisse_id = $('#banque_id').val(); // banque → caisse_id
            }
