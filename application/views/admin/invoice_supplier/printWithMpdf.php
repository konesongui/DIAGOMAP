<?php
    ...
    $payment_method = !empty($invoice['method'])? $invoice['payment_method'] :"N/A";
        ...
        <div class="invoice-content" style="margin-top: 0;">
            ...
            <div style="margin-top: 10px; padding: 10px; background-color: rgba(19, 96, 171, 0.05); border-radius: 5px; border-left: 4px solid rgb(250, 183, 22);">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="width: 50%; padding: 5px; vertical-align: top;">
                            <div style="font-weight: bold; color: rgb(19, 96, 171); font-size: 12px;">Notes :</div>
                            <div style="color: #333; font-size: 12px;"><?= $notes;?></div>
                        </td>
                        <td style="width: 50%; padding: 5px; vertical-align: top;">
                            <div style="font-weight: bold; color: rgb(19, 96, 171); font-size: 12px;">Référence :</div>
                            <div style="color: #333; font-size: 12px;"><?= $reference;?></div>
                        </td>
                    </tr>
                </table>
            </div>
