...
<head>
    <meta charset="UTF-8">
    <title>Bon de livraison N° <?= $deliveryNumber ?></title>
    <style>
        body {
...
<body style="font-family: Arial, sans-serif; font-size: 12px; color: white; margin: 0; padding: 0; width: 21cm;">

<!-- En-tête -->
<div style="background-color: white; padding: 8px; text-align: center; font-weight: bold; font-size: 16px; color: #000; border-radius: 5px; margin-bottom: 5px;">
    Bon de livraison N° <?= $deliveryNumber ?>
</div>
...
<table style="width: 100%; border-collapse: collapse; margin-top: 12px;">
    <thead>
    <tr>
        <th style="background-color: white; color: black; padding: 5px; text-align: left;">Qté</th>
        <th style="background-color: white; color: black; padding: 5px; text-align: left;">Description</th>
        <!--<th style="background-color: white; color: black; padding: 5px; text-align: left;">PU (CFA)</th>
        <th style="background-color: white; color: black; padding: 5px; text-align: left;">Total (CFA)</th>-->
    </tr>
    </thead>
    <tbody>
    <?php foreach ($items as $index => $item): ?>
        <tr style="background-color: black <?= $index % 2 == 0 ? 'white' : 'transparent'; ?>">
            <td style="border: 1px solid black; padding: 5px;"><?= htmlspecialchars($item['quantity']) ?></td>
            <td style="border: 1px solid black; padding: 5px;"><?= htmlspecialchars($item['item_name']) ?> - <?= htmlspecialchars($item['category_name']) ?></td>
           <!-- <td style="border: 1px solid black; padding: 5px;"><?= number_format($item['unit_price'],0,',',' ') ?></td>
            <td style="border: 1px solid black; padding: 5px;"><?= number_format($item['line_total'],0,',',' ') ?></td>-->
        </tr>
    <?php endforeach; ?>
    </tbody>
</table>
...
<div style="margin-top: 15px; padding: 10px; background-color: white; border-left: 4px solid black; border-radius: 5px;">
...
<div style="position: fixed; bottom: 0.3cm; left: 0.3cm; right: 0.3cm;
    background-color: white; padding: 3px; font-size: 9px;
