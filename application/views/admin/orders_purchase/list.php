...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-object-group"></i> Bon de commande
        </h1>
    </section>
    <!-- Main content -->
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <?php if ($this->rbac->hasPrivilege('order_item', 'can_add')) {
                                ?>
                                <a href="<?php echo site_url('admin/orders_purchase/form') ?>" type="button" class="btn btn-primary btn-sm" ><i class="fa fa-plus"></i> Ajouter un devis</a>
                            <?php }
                            ?>
...
<script src="<?= base_url('assets/js/orders_purchase/index.js') ?>"></script>