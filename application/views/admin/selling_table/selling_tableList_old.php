...
// Connexion BDD
// ===============================
$conn = new mysqli("91.216.107.185","diago2476193_2knvj8","gY9*@2HrqvEb1jy","diago2476193_2knvj8");
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="box box-danger">
                    <div class="box-header">
                        <h3 class="box-title">ðÂÂÂÂÂÂ Stock faible / À réapprovisionner</h3>
                    </div>
                    <div class="box-body">
                        <table class="table table-bordered table-striped">
                            ...
                            <?php } else { ?>
                                <tr>
                                    <td colspan="3" class="text-center">âÂÂÂÂ Aucun produit en stock faible</td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
            ...
            <div class="col-md-10">
                <div class="box box-success">
                    <div class="box-header">
                        <h3 class="box-title">ð° Récapitulatif des paiements clients</h3>
                    </div>
                    <div class="box-body">
                        <table class="table table-bordered table-striped">
                            <thead>
                ...
                <?php echo number_format($client['paye'], 0, ',', ' '); ?> FCFA
                        ...
                        <?php echo number_format($client['reste'], 0, ',', ' '); ?> FCFA
                                            ...
                                            <?php } else { ?>
                                                <span class="label label-success">â Soldé</span>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
                                <!-- â Ligne Total Général -->
                            ...
                            <?php } else { ?>
                                <tr>
                                    <td colspan="5" class="text-center">â Aucun paiement enregistré</td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
