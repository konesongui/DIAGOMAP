...
$formModalStockEntryID = 'stockEntryFormModal';
$dtStockEntryID = 'stockEntryDatatable';
$dtStockEntrySearchText = 'stockEntryDatatableSearchQuery';
$dtDatePicker = 'ktEntryDaterangePicker';
$dtDatePickerDefault = 'ktEntryDaterangePickerDefaut';
$dtStockEntryButtons = [
	'set'	=> 'stockEntryForm',
	'reload'	=> 'reloadStockEntryDatatable',
];
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('issue_item', 'can_add')) {
                                ?>
                                <a href="<?php echo site_url('admin/issueitem/create') ?>" type="button" class="btn btn-primary btn-sm" ><i class="fa fa-plus"></i> Ajouter une entrée de stock</a>
                            <?php }
                            ?>
                    ...
                    <div class="box-body">
                        <div class="mailbox-messages table-responsive">
                                 <table id="{{ $dtStockEntryID }}" class="table table-striped table-bordered table-hover item-list" data-export-title="<?php echo $this->lang->line('issue_item'); ?>">
                                <thead>
                                    <tr>
                                        <th>Référence</th>
                                        <th>Origine</th>
