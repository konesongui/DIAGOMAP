                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <!-- Bouton toggle tableau de bord bénéfice -->
                            <button type="button" class="btn btn-info btn-sm" id="toggleProfitDashboard" style="margin-right: 5px;">
                                <i class="fa fa-line-chart"></i> Afficher tableau de bord bénéfice
                            </button>
                            <!-- Dans la zone box-tools, ajoutez ce bouton
                            <button type="button" class="btn btn-primary btn-sm" id="openStockModal" style="margin-right: 5px;">
                                <i class="fa fa-info-circle"></i> Voir valeurs du stock
                            </button>-->
                            <div class="btn-group">
                    ...
                    <div class="box-body">
                        ...
                        <!-- Tableau principal avec les 3 colonnes demandées -->
...
<!-- Modal PDF (identique à l'original) -->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        // DataTable avec les nouvelles colonnes
    ...
    // Fonction de mise à jour du pop-up (réutilise les données déjà chargées ou recharge)
    function updateStockModal() {
        // Si vous voulez toujours des données fraîches, faites un appel AJAX
        $.get(baseurl + 'admin/itemstock/get_profit_totals', function(res) {
            if (res.status === 'success') {
    ...
    // Optionnel : si vous voulez que le pop-up affiche les mêmes valeurs que le dashboard déjà visible
    // vous pouvez simplement copier les valeurs des cartes existantes :
    /*
    function updateStockModalFromDashboard() {
        $('#modal-valeur-achat').text($('#total-valeur-achat').text());
        $('#modal-valeur-vente').text($('#total-valeur-vente').text());
        $('#modal-benefice').text($('#total-benefice').text());
    }
    */
</script>
