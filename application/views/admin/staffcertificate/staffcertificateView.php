                        ...
                        <form id="form1" enctype="multipart/form-data" action="<?php echo site_url('admin/staffcertificate/create') ?>"  id="certificateform" name="certificateform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <input id="name" name="username" placeholder="" type="text" class="form-control"  value="<?php echo $this->customlib->getAdminSessionUserName(); ?>" />
                                    <span class="text-danger"><?php echo form_error('username'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label>Titre du certificat</label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    <label>Informations</label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    <label>Sous titre</label><small class="req"> *</small>
