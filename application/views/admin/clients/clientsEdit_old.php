                        ...
                        <form action="<?php echo site_url("admin/clients/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="ville" name="ville" placeholder="" type="text" class="form-control"  value="<?php echo set_value('ville', $itemsupplier['ville']); ?>" />
                            ...
                            <div class="box-footer">
                                ...
                                <a href="<?php echo base_url() ?>admin/clients" type="button" class="btn btn-primary btn-xs" style="width: 99px;height: 23px">
