                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <!-- <div class="box-tools pull-right">
                            <a href="<?php echo base_url('admin/orders_purchases/print/'.$quote['id']); ?>" class="btn btn-primary btn-sm" target="_blank">
                                <i class="fa fa-print"></i> Imprimer
                            </a>
                            <a href="<?php echo base_url('admin/orders_purchases/sendEmail/'.$quote['id']); ?>" class="btn btn-info btn-sm">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Informations de bon de commande</h4>
