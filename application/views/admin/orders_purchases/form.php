            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <form action="<?php echo site_url('admin/orders_purchases/add') ?>" id="<?= $formID; ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <div class="row">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php echo base_url('admin/orders_purchases'); ?>" class="btn btn-default">
