        ...
        <div class="row">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Modifier le bon de commande fournisseur <?php echo $quote['quote_number']; ?></h3>
                </div>
                
                <form action="<?php echo site_url('admin/orders_purchases/update') ?>" id="<?= $formID; ?>" method="post" accept-charset="utf-8">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input id="objet" name="objet" type="text" class="form-control date" value="<?php echo $quote['objet']; ?>" />
                                </div>
                            </div>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo base_url('admin/orders_purchases/index'); ?>" class="btn btn-default">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/orders_purchases/actions.js"></script>