...
<head>
    <meta charset="utf-8">
    <title>Bon de commande <?php echo $quote['quote_number']; ?></title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>Bon de commande <?php echo $quote['quote_number']; ?></h1>
        </div>
        ...
        <div class="quote-info">
            <p>Cher client,</p>
            <p>Veuillez trouver ci-joint le bon de commande <?php echo $quote['quote_number']; ?> concernant <?php echo $quote['designation']; ?>.</p>
