...
<body style="font-family: Arial, sans-serif; font-size: 12px; color: rgb(19, 96, 171); margin: 0; padding: 0; width: 21cm; height: auto;">
    <div style="padding-bottom: 2cm;">
        <div style="background-color: rgb(250, 183, 22); padding: 5px; text-align: center; font-weight: bold; font-size: 16px; color: #000; border-radius: 5px; margin-bottom: 3px;">Bon de commande N° <?= $quoteNumber ?> du <?= $quoteDate ?></div>
        <div style="margin-top: 0;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 3px; margin-bottom: 3px;">
                ...
                <tr>
                    ...
                    <td style="width:55 %; padding: 10px 5px 10px 20px; vertical-align: top;">
                        <span style="color: rgb(19, 96, 171); font-weight: bold;">Fournisseur :</span> <?= $customerFullname ?><br>
                        ...
                        <span style="color: rgb(19, 96, 171); font-weight: bold;">Adresse email :</span> <?= $customerAddress ?><br>
                        <span style="color: rgb(19, 96, 171); font-weight: bold;">Adresse  :</span> <?= $customerAddresse ?><br>
                        <!--<span style="color: rgb(19, 96, 171); font-weight: bold;">Nom du responsable  :</span> <?= $customerResponsable ?><br>-->
            ...
            <div style="margin-top: 10px; padding: 10px; background-color: rgba(19, 96, 171, 0.05); border-radius: 5px; border-left: 4px solid rgb(250, 183, 22);">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="width: 50%; padding: 5px; vertical-align: top;">
                            <div class="payment-label">Terme de livraison :</div>
                            <div class="payment-value"><?= $delivery_terms;?></div>
                        </td>
                        <td style="width: 50%; padding: 5px; vertical-align: top;">
                            <div class="payment-label">Lieu de livraison :</div>
                            <div class="payment-value"><?= $delivery_location;?></div>
                        </td>

                        <td style="width: 50%; padding: 5px; vertical-align: top;">
                            <div class="payment-label">Règlement :</div>
                            <div class="payment-value"><?= $payment_terms;?></div>
                        </td>
                    </tr>
                </table>
            </div>
