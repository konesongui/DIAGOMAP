...
<body>
    <div class="main-content">
        <div class="head">Bon de commande N° <?= $quoteNumber ?> du <?= $quoteDate ?></div>
            ...
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <strong>Adresse email :</strong> <?= $customerAddress ?><br>
                        <strong>Adresse :</strong> <?= $customerAddresse ?><br>
                       <!--< <strong>Nom du responsable :</strong> <?= $customerResponsable ?><br>-->
                ...
                <tr>
                    <td colspan="6" style="padding: 10px;">
                        <strong>Objet :</strong> <?= $quoteObjet ;?>
                    </td>
                </tr>
            </table><br>
