    ...
    <section class="content">
        <div class="row">
            <div class="box box-primary">
                ...
                <form action="<?php echo site_url('admin/orderformitem/update') ?>" id="<?= $formID; ?>" method="post" accept-charset="utf-8">
                    <div class="box-body">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select class="form-control" name="customer">
                                    ...
                                    <?php foreach ($supplier as $suppliers) { ?>
                                        <option value="<?php echo $suppliers['id']; ?>" <?php echo ((int)$suppliers['id'] == (int)$order['customer_id']) ? 'selected' : ''; ?>>
