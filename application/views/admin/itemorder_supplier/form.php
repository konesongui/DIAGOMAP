            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <form action="<?php echo site_url('admin/orderformitem_supplier/add') ?>" id="<?= $formID; ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input id="order_date" name="order_date" type="text" class="form-control date" value="<?= set_value('order_date', date('d/m/Y')) ?>" readonly />
                                </div>
                                <div class="form-group col-md-3">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/order/actions.js"></script>