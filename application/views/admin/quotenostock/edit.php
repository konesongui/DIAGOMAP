    ...
    <section class="content">
        <div class="row">
            <div class="box box-primary">
                ...
                <form action="<?php echo site_url('admin/quotenostock/update') ?>" id="<?= $formID; ?>" method="post" accept-charset="utf-8">
                    <div class="box-body">
                                    ...
                                    <?php foreach ($quote['items'] as $item) { ?>
                                        <div class="repeater-item">
                                            ...
                                            <div class="form-group col-md-2">
                                                    ...
                                                    <input type="text" name="item_category[]" class="form-control item-category" value="<?php echo $item['category_name']; ?>" required>
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label>Article <small class="req">*</small></label>
                                                    <input type="text" name="item[]" class="form-control item-select" value="<?php echo $item['product_name']; ?>" required>
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <label>Unité</label>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo base_url('admin/quotenostock'); ?>" class="btn btn-default">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/quotenostock/actions.js"></script> 