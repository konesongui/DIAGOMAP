            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <form action="<?php echo site_url('admin/quotenostock/add') ?>" id="<?= $formID; ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <div class="row">
                                        ...
                                        <div class="repeater-item">
                                            <div class="row">
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="text" name="item_category[]" class="form-control item-category" required>
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label>Article <small class="req">*</small></label>
                                                    <input type="text" name="item[]" class="form-control item-select" required>
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <label>Unité</label>
