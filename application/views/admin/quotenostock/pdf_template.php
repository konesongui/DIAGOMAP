...
<head>
    <meta charset="UTF-8">
    <title>Devis <?php echo $quotation_number; ?></title>
    <style>
        body {
...
<body>
    ...
    <div class="info">
        <div class="info-row"><strong>N° Devis:</strong> <?php echo $quotation_number; ?></div>
    ...
    <div class="validity">
        Validité du devis: <?php echo $this->calculateValidityDays($data['quote']['quote_date'], $data['quote']['valid_until']); ?> jours
    </div>
</body>
</html> 