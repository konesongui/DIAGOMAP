...
<style type="text/css">
    ...
    .form-control:focus{
        ...
        box-shadow:0 0 0 3px var(--pf-amber-soft, #FBF3E1);
    }
    ...
    #add-item:hover{ background:var(--pf-amber-soft); }
...
<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-file-text-o"></i> Devis</h1>
        <small><?= $isEdit ? 'Modifier le devis' : 'Créer un devis' ?></small>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?= $isEdit ? 'Modifier le devis' : 'Créer un devis' ?></h3>
                    </div>

                    <form action="<?= site_url($isEdit ? 'admin/quoteitem/update' : 'admin/quoteitem/add') ?>" id="<?= $formID; ?>" method="post" accept-charset="utf-8">
                        <?php if ($isEdit): ?>
                                    ...
                                    <div id="items-container">
                                        <?php if ($isEdit && !empty($quote['items'])): ?>
                                            ...
                                            foreach ($quote['items'] as $index => $item):
                                                ?>
                                                <div class="repeater-item" data-item-type="<?= $item['item_type'] ?>" data-index="<?= $itemIndex ?>">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?= base_url('admin/quoteitem') ?>" class="btn btn-default"><i class="fa fa-arrow-left"></i> Retour</a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $('#<?= $formID; ?>').on('submit', function(e) {
            ...
            Swal.fire({
                title: "Confirmation",
                text: "Voulez-vous vraiment " + (<?= json_encode($isEdit) ?> ? "mettre à jour" : "créer") + " ce devis ?",
                icon: "question",
