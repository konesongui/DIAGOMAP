...
<style type="text/css">
    ...
    /* Nouveaux styles pour le module de paiement */
    .payment-module {
        background: #f8f9fa;
                ...
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/Selling/add') ?>" id="<?= $formID; ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <!-- NOUVEAU MODULE DE PAIEMENT AJOUTÉ -->
...
<script type="text/javascript">
    ...
    // Variable pour stocker le total TTC (ajoutée pour le module de paiement)
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function calculateTotals() {
            ...
            // Mettre à jour la variable globale pour le module de paiement
            ...
            // Mettre à jour le module de paiement
            updatePaymentModule();
        }

        // 🔹 NOUVELLE FONCTION: Mettre à jour le module de paiement
        function updatePaymentModule() {
            let paid = parseFloat(document.getElementById('amount_paid').value) || 0;
            let remaining = currentTotalTTC - paid;

            if (remaining < 0) {
                document.getElementById('change_amount').value = Math.abs(remaining).toFixed(2) + ' FCFA';
        ...
        // 🔹 NOUVEAU: Écouteur pour le montant payé
