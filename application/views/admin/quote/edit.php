...
<style type="text/css">
    ...
    .alert-info{
        ...
        background:var(--pf-amber-soft, #FBF3E1);
        color:var(--pf-ink);
    }
    .alert-danger{
        border-radius:9px;
...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <small>Modifier le devis <?php echo $quote['quote_number']; ?></small>
    </section>
                ...
                <form action="<?php echo site_url('admin/quoteitem/update') ?>" id="<?= $formID; ?>" method="post" accept-charset="utf-8">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <h4>Articles / Services du devis <small class="text-muted">(Glissez-déposez pour réorganiser)</small></h4>
