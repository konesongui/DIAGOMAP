...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function calculateItemTotal(item) {
            ...
            // Calcul du total HT normal (sans remise)
            ...
            if (discountType === 'percent') {
                ...
                discountAmount = Math.min(discount, totalHT); // Ne pas dépasser le total HT
            }
        ...
        // Événements pour les champs de quantité, prix et remise
        ...
        document.getElementById('add-item').addEventListener('click', function() {
            ...
            // Réinitialiser les valeurs du nouvel article
            ...
            // Réinitialiser les boutons de type de remise
            ...
            // Configurer les boutons de type de remise
        ...
        // ð Gestion de la soumission du formulaire avec confirmation
        document.getElementById('<?= $formID; ?>').addEventListener('submit', function(e) {
            e.preventDefault(); // Bloque la soumission classique

            // Popup de confirmation avant validation
            Swal.fire({
                title: "Confirmation",
        ...
        // Initialiser les boutons de type de remise
        setupDiscountTypeButtons();
