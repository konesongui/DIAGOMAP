                                    ...
                                    <div class="sameheight">
                                        <div class="payrollbox feebox">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control" name="its" id="total_fiscal" value="0"  type="text" />
                                                </div>
                                            </div>
...
<script type="text/javascript">
    ...
    function add_allowance() {
        ...
        var cmu = 500;
        var prime= 30000;
        var total_po = (basic_pay + sursalaire + prime_anc + tax  + prime_trans + forfait_hs + prime_resp + prime_rend + prime_risque + prime_assi + prime_grati) * 0.1;
...
//fin prime transport
        ...
        if (prime_anc > total_po) {
            anc = prime_anc - total_po;
        } else {
            anc =0;
        }
        final_anc = anc;
...
//prime rendement
        if (prime_rend > total_po)
        {
            rends= prime_rend - total_po;
        }
        else{
            rends = 0;
        }
...
//fin prime respon
        ...
        //prime rendement
        if (prime_resp > total_po)
        {
            resp= prime_resp - total_po;
        }
        else{
            resp = 0;
        }
...
//prime risque
        ...
        if (prime_risque > total_po) {
            risq = prime_risque - total_po;
        } else {
            risq= 0;
        }
...
//prime assiduité
        ...
        if (prime_assi > total_po) {
            assi = prime_assi - total_po;
        } else {
            assi = 0;
        }
        ...
        if (forfait_hs > total_po) {
            forfait = forfait_hs - total_po;
        } else {
            forfait = 0;
        }
...
//total_deduction += parseInt(leave_deduction) ;
        ...
        var total_social = parseFloat(gross_salary)- parseFloat(prime_trans);
        var total_fiscal = parseFloat(basic_pay) + parseFloat(sursalaire) + parseFloat(final_anc) + parseFloat(final_trans) + parseFloat(final_forfait) + parseFloat(final_resp) + parseFloat(final_rend) + parseFloat(final_risq) + parseFloat(final_assi);
        ...
        var total_pourcentage = gross_salary * 0.1;
        ...
        $("#total_pourcentage").val(total_pourcentage.toFixed(2));
        ...
        $("#total_fiscal").val(total_fiscal.toFixed(2));
