                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <?php if ($this->rbac->hasPrivilege('order_item', 'can_add')) {
                                ?>
                                <a href="<?php echo site_url('admin/orderformitem_purchase/form') ?>" type="button" class="btn btn-primary btn-sm" ><i class="fa fa-plus"></i> Ajouter un bon de commande</a>
                            <?php }
                            ?>
...
<script src="<?= base_url('assets/js/order_purchase/index.js') ?>"></script>