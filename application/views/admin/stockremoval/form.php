        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/stockremoval/add') ?>" id="<?= $formID; ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label>Origine <small class="req">*</small></label>
                                    <input name="origin" type="text" class="form-control" value="<?= set_value('origin') ?>" />
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    <label>Motif <small class="req">*</small></label>
                                    <input name="reason" type="text" class="form-control" value="<?= set_value('reason') ?>" />
                                </div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/stockremoval/actions.js"></script>