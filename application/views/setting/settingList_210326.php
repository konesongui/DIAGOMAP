            ...
            <div class="col-lg-12 col-md-9 col-sm-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="">
                        <form role="form" id="schsetting_form" action="<?php //echo site_url('schsettings/ajax_schedit_new')      ?>" class="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4">Raison sociale<small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="name" name="name" value="<?php echo $result->name; ?>">
                                                <span class="text-danger"><?php echo form_error('name'); ?></span> <input type="hidden" name="name" value="<?php echo $result->id; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4">Registre de commerce<small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="registre_commerce" name="registre_commerce" value="<?php echo $result->registre_commerce; ?>">
                                                <span class="text-danger"><?php echo form_error('registre_commerce'); ?></span> <input type="hidden" name="registre_commerce" value="<?php echo $result->registre_commerce; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4">Compte contribuable<small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="compte_contribuable" name="compte_contribuable" value="<?php echo $result->compte_contribuable; ?>">
                                                <span class="text-danger"><?php echo form_error('compte_contribuable'); ?></span> <input type="hidden" name="compte_contribuable" value="<?php echo $result->compte_contribuable; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4">Forme juridique<small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="forme_jurique" name="forme_jurique" value="<?php echo $result->forme_jurique; ?>">
                                                <span class="text-danger"><?php echo form_error('forme_jurique'); ?></span> <input type="hidden" name="forme_jurique" value="<?php echo $result->forme_jurique; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4">Numéro CNPS<small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="cnps_number" name="cnps_number" value="<?php echo $result->cnps_number; ?>">
                                                <span class="text-danger"><?php echo form_error('cnps_number'); ?></span> <input type="hidden" name="cnps_number" value="<?php echo $result->cnps_number; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4">Boîte Postale<small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="boite_postal" name="boite_postal" value="<?php echo $result->boite_postal; ?>">
                                                <span class="text-danger"><?php echo form_error('boite_postal'); ?></span> <input type="hidden" name="boite_postal" value="<?php echo $result->boite_postal; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4">Nom de la banque</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="bank" name="bank" value="<?php echo $result->bank; ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4">Compte Bancaire</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="compt_bank" name="compt_bank" value="<?php echo $result->compt_bank; ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4">Centre des impôts</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="centre_impot" name="centre_impot" value="<?php echo $result->centre_impot; ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4">Regime d'imposition</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="regime_imposition" name="regime_imposition" value="<?php echo $result->regime_imposition; ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4">NCCM<small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="rccm" name="rccm" value="<?php echo $result->rccm; ?>"><span class="text-danger"><?php echo form_error('rccm'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4">Site web<small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="site_web" name="site_web" value="<?php echo $result->site_web; ?>"><span class="text-danger"><?php echo form_error('site_web'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4">Activité de l'entreprise<small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="company_activity" name="company_activity" value="<?php echo $result->company_activity; ?>"><span class="text-danger"><?php echo form_error('company_activity'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4">Nom du fornisseur<small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="company_supplier" name="company_supplier" value="<?php echo $result->company_supplier; ?>"><span class="text-danger"><?php echo form_error('company_supplier'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-12 uploadsticky" style="margin-left: 812px">
                                    <div class="box box-primary">
                        ...
                        <br/>
                        <br/>
                        <a href="#schsetting" role="button" class="btn btn-primary btn-sm upload_logo" data-toggle="tooltip" title="<?php echo $this->lang->line('edit') . " " . $this->lang->line('print') . " " . $this->lang->line('logo'); ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-picture-o"></i> Logo de facturation</a>
                    </div>-->
                                    </div>
                                    ...
                                    <div class="box box-primary">
                                        <div class="box-body text-center">
                                            ...
                                            <br/>
                                            <br/>
                                            <a href="#admin_logo" role="button" class="btn btn-primary btn-sm upload_admin_logo" data-toggle="tooltip" title="<?php echo $this->lang->line('edit') . " " . $this->lang->line('logo'); ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-picture-o"></i> <?php echo $this->lang->line('edit') . " " . $this->lang->line('logo'); ?></a>
                                        </div>
                                    </div>
                                    <!--<div class="box box-primary">
                    <div class="box-body text-center">
